...
export function useErrorRecovery(campaignId: string) {
  ...
  const checkForPendingOperations = useCallback(() => {
    try {
      ...
      const hasRecoverableOperations =
        pendingUpdates.length > 0 || pendingSubmission !== null || pendingUpload !== null;
   ...
   */
  const recoverPendingOperations = useCallback(
    async (
      handlers: {
    ...
    toast(
      t => (
        <div className="p-2 font-body">
          <p className="font-medium mb-2 font-body">
            You have unsaved changes. Would you like to recover them?
          </p>
          <div className="flex gap-2 font-body">
            <button
              ...
              className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 font-body"
            >
              Recover
            </button>
            <button
              ...
              className="px-4 py-2 bg-gray-300 rounded hover:bg-gray-400 font-body"
            >
              Discard
            </button>
          </div>
