  ...
  return (
    <div className="flex flex-wrap gap-4 items-end">
      <div className="flex flex-col">
        <label htmlFor="platformFilter" className="text-sm font-semibold mb-1">
          Platform
        </label>
        <select
          id="platformFilter"
      ...
      <div className="flex flex-col">
        <label htmlFor="tierFilter" className="text-sm font-semibold mb-1">
          Tier
        </label>
        <select
          id="tierFilter"
      ...
      {showSorting && (
        <div className="flex flex-col">
          <label htmlFor="sortFilter" className="text-sm font-semibold mb-1">
            Sort By
          </label>
          <select
            id="sortFilter"
