            ...
            render={({ field, fieldState }) => {
                ...
                return (
                    <FormItem>
                                ...
                                return (
                                    ...
                                    <FormLabel
                                        ...
                                        className={cn(
                                            ...
                                            isSelected ? "bg-accent text-accent-foreground border-accent/50" : "hover:bg-muted/50"
                                        )}
                                    ...
                                    >
                                        <Checkbox
                                            ...
                                            className={cn(isSelected && "border-accent-foreground [&>span]:bg-accent-foreground")}
                                        />
                        ...
                        {fieldState.error && <FormMessage className="pt-1">{fieldState.error.message}</FormMessage>}
                    </FormItem>
                )
            }}
        />
