...
const PaginationEllipsis = ({ className, ...props }: React.ComponentProps<'span'>) => (
  <span aria-hidden className={cn('flex h-9 w-9 items-end justify-center', className)} {...props}>
    <Icon iconId="faEllipsisLight" className={cn('h-4 w-4 text-muted-foreground', 'pb-1')} />
