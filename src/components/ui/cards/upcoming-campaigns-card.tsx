    ...
    >
      <div className="p-3 sm:p-4 font-work-sans">
        <div className="flex items-start justify-between font-work-sans">
          ...
          <div className={`flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 rounded-md flex items-center justify-center ${campaign.platform === 'Instagram' ? 'bg-gradient-to-br from-purple-500 to-pink-500' : campaign.platform === 'TikTok' ? 'bg-black' : 'bg-red-600'} font-work-sans`} data-cy="platform-icon">
        ...
        <div className="mt-3 grid grid-cols-2 gap-2 sm:gap-4 text-xs font-work-sans">
          <div className="font-work-sans" data-cy="campaign-budget">
          ...
          <div className="font-work-sans" data-cy="campaign-kpi">
...
const UpcomingCampaignsCard: React.FC<UpcomingCampaignsCardProps> = ({
  ...
  return (
    <div className="rounded-lg bg-white border border-[var(--divider-color)] overflow-hidden font-work-sans" data-cy="upcoming-campaigns-card">
      <div className="p-4 sm:p-5 border-b border-[var(--divider-color)] font-work-sans">
        <div className="font-work-sans">
          <h2 className="text-lg font-medium font-sora">Upcoming Campaigns</h2>
          <p className="text-sm text-[var(--secondary-color)] mt-1 font-work-sans">Track and manage your upcoming campaigns</p>
        </div>
      </div>
