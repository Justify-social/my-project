...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <Icon iconId="faChevronDownLight"  className="h-4 w-4 opacity-50" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <Icon iconId="faChevronUpLight"  className="h-4 w-4" />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <Icon iconId="faChevronDownLight"  className="h-4 w-4" />
  </SelectPrimitive.ScrollDownButton>
));
...
/**
 * select - Combined component exporting all subcomponents
 * 
