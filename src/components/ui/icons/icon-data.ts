...
export type IconName = 'faForward' | 'faCalendar' | 'faSave' | 'faChevronLeft' | 'faChevronRight' | 'faRotateRight' | 'faTriangleExclamation' | 'faWarning' | 'faSpinner' | 'faFile' | 'faFileVideo' | 'faFileImage' | 'faFileAudio' | 'faPlay' | 'faPause' | 'faUpload' | 'faInfo' | 'faMinus' | 'faPlus' | 'faCircleCheck' | 'faCheck' | 'faCircleXmark' | 'faCircleInfo' | 'faXmark' | 'faChevronUp' | 'faChevronDown' | 'faQuestion' | 'faEnvelope' | 'faPaperPlane' | 'faFileLines' | 'faTrashCan' | 'faGear' | 'faHouse' | 'faGlobe' | 'faMagnifyingGlass' | 'faLock' | 'faBell' | 'faEye' | 'faPenToSquare' | 'faCopy' | 'faUser' | 'faArrowDown' | 'faArrowLeft' | 'faArrowRight' | 'faArrowUp' | 'faArrowTrendDown' | 'faArrowTrendUp' | 'faBars' | 'faBellSlash' | 'faBolt' | 'faBookmark' | 'faBug' | 'faBuilding' | 'faBullseye' | 'faCalendarDays' | 'faCamera' | 'faChartBar' | 'faChartColumn' | 'faChartLine' | 'faChartPie' | 'faCommentDots' | 'faCircleQuestion' | 'faCircleUser' | 'faClock' | 'faClockRotateLeft' | 'faComment' | 'faComments' | 'faCreditCard' | 'faDollarSign' | 'faDownload' | 'faExclamation' | 'faFilter' | 'faFlag' | 'faFlagCheckered' | 'faHeart' | 'faHome' | 'faImage' | 'faKey' | 'faLightbulb' | 'faList' | 'faSearch' | 'faMagnifyingGlassPlus' | 'faMap' | 'faMegaphone' | 'faMoneyBill' | 'faPalette' | 'faPaperclip' | 'faPen' | 'faPhone' | 'faPresentationScreen' | 'faPrint' | 'faRocket' | 'faRotate' | 'faServer' | 'faShare' | 'faShield' | 'faSignal' | 'faStar' | 'faTable' | 'faTableCells' | 'faTag' | 'faThumbsUp' | 'faTrophy' | 'faUnlock' | 'faUserGroup' | 'faVideo' | 'faClose' | 'faEdit' | 'faUserCircle' | 'faRightFromBracket' | 'faRightToBracket' | 'faDollar' | 'faHistory' | 'faCheckCircle' | 'faTrash' | 'faPencil' | 'faTrashAlt' | 'faCircleNotch' | 'faEyeSlash' | 'faCircle' | 'faQuestionCircle' | 'faFloppyDisk' | 'faUsers' | 'faInfoCircle' | 'faExclamationTriangle' | 'faHamburger' | 'faMagnifyingGlassPlusLight' | 'faBoltLight' | 'faUserCircleLight' | 'faShieldLight' | 'faPresentationScreenLight' | 'faChevronDownLight' | 'faArrowDownLight' | 'faForwardLight' | 'faTrophyLight' | 'faArrowUpLight' | 'faPlayLight' | 'faTableCellsLight' | 'faLockLight' | 'faArrowLeftLight' | 'faDollarLight' | 'faCheckLight' | 'faCircleInfoLight' | 'faCircleCheckLight' | 'faSaveLight' | 'faClockRotateLeftLight' | 'faRotateLight' | 'faMinusLight' | 'faPhoneLight' | 'faBellLight' | 'faKeyLight' | 'faCalendarDaysLight' | 'faFileLinesLight' | 'faMegaphoneLight' | 'faBugLight' | 'faPrintLight' | 'faFlagLight' | 'faChevronRightLight' | 'faGlobeLight' | 'faVideoLight' | 'faCommentDotsLight' | 'faPlusLight' | 'faShareLight' | 'faTrashLight' | 'faUserGroupLight' | 'faBookmarkLight' | 'faCreditCardLight' | 'faEyeSlashLight' | 'faQuestionLight' | 'faSignalLight' | 'faChevronUpLight' | 'faPaletteLight' | 'faPauseLight' | 'faArrowTrendDownLight' | 'faSearchLight' | 'faUnlockLight' | 'faCircleUserLight' | 'faBellSlashLight' | 'faDollarSignLight' | 'faCircleNotchLight' | 'faBuildingLight' | 'faTriangleExclamationLight' | 'faFloppyDiskLight' | 'faLightbulbLight' | 'faCopyLight' | 'faChartLineLight' | 'faRightToBracketLight' | 'faMapLight' | 'faUserLight' | 'faPaperPlaneLight' | 'faChartColumnLight' | 'faPaperclipLight' | 'faGearLight' | 'faWarningLight' | 'faEnvelopeLight' | 'faThumbsUpLight' | 'faChartBarLight' | 'faImageLight' | 'faExclamationLight' | 'faMoneyBillLight' | 'faRightFromBracketLight' | 'faCircleQuestionLight' | 'faListLight' | 'faArrowRightLight' | 'faCommentLight' | 'faTableLight' | 'faBullseyeLight' | 'faChartPieLight' | 'faInfoLight' | 'faChevronLeftLight' | 'faCommentsLight' | 'faUploadLight' | 'faMagnifyingGlassLight' | 'faCalendarLight' | 'faCircleLight' | 'faCircleXmarkLight' | 'faTrashCanLight' | 'faFlagCheckeredLight' | 'faDownloadLight' | 'faHistoryLight' | 'faPenLight' | 'faHeartLight' | 'faQuestionCircleLight' | 'faRocketLight' | 'faSpinnerLight' | 'faArrowTrendUpLight' | 'faTrashAltLight' | 'faEyeLight' | 'faExclamationTriangleLight' | 'faClockLight' | 'faServerLight' | 'faCheckCircleLight' | 'faFileLight' | 'faCameraLight' | 'faTagLight' | 'faHamburgerLight' | 'faFilterLight' | 'faInfoCircleLight' | 'faBarsLight' | 'faUsersLight' | 'faStarLight' | 'faPencilLight';
