...
export type IconName = 'faForward' | 'faChevronLeft' | 'faChevronRight' | 'faCalendar' | 'faUpload' | 'faInfo' | 'faMinus' | 'faPlus' | 'faChevronUp' | 'faChevronDown' | 'faQuestion' | 'faCircleInfo' | 'faTrashCan' | 'faTriangleExclamation' | 'faCircleCheck' | 'faUser' | 'faSearch' | 'faBell' | 'faEdit' | 'faCopy' | 'faArrowDown' | 'faArrowLeft' | 'faArrowRight' | 'faArrowUp' | 'faArrowTrendDown' | 'faArrowTrendUp' | 'faBars' | 'faBellSlash' | 'faBolt' | 'faBookmark' | 'faBug' | 'faBuilding' | 'faBullseye' | 'faCalendarDays' | 'faCamera' | 'faChartBar' | 'faChartColumn' | 'faChartLine' | 'faChartPie' | 'faCommentDots' | 'faCheck' | 'faCircleQuestion' | 'faCircleUser' | 'faCircleXmark' | 'faClock' | 'faClockRotateLeft' | 'faXmark' | 'faComment' | 'faComments' | 'faCreditCard' | 'faDollarSign' | 'faFile' | 'faFileLines' | 'faDownload' | 'faPenToSquare' | 'faEnvelope' | 'faExclamation' | 'faEye' | 'faFilter' | 'faFlag' | 'faFlagCheckered' | 'faGear' | 'faGlobe' | 'faHeart' | 'faHome' | 'faImage' | 'faKey' | 'faLightbulb' | 'faList' | 'faLock' | 'faMagnifyingGlassPlus' | 'faMap' | 'faMegaphone' | 'faMoneyBill' | 'faPalette' | 'faPaperclip' | 'faPaperPlane' | 'faPen' | 'faPhone' | 'faPlay' | 'faPresentationScreen' | 'faPrint' | 'faRocket' | 'faRotate' | 'faServer' | 'faShare' | 'faShield' | 'faSignal' | 'faSpinner' | 'faStar' | 'faTable' | 'faTableCells' | 'faTag' | 'faThumbsUp' | 'faTrophy' | 'faUnlock' | 'faUserGroup' | 'faVideo' | 'faClose' | 'faUserCircle' | 'faWarning' | 'faDollar' | 'faHistory' | 'faHouse' | 'faMagnifyingGlass' | 'faCheckCircle' | 'faTrash' | 'faPencil' | 'faArrowDownLight' | 'faChevronDownLight' | 'faBoltLight' | 'faCircleCheckLight' | 'faMinusLight' | 'faMagnifyingGlassPlusLight' | 'faCalendarDaysLight' | 'faUserLight' | 'faCommentDotsLight' | 'faBarsLight' | 'faLightbulbLight' | 'faEnvelopeLight' | 'faShieldLight' | 'faListLight' | 'faBookmarkLight' | 'faArrowTrendDownLight' | 'faPenToSquareLight' | 'faCalendarLight' | 'faGearLight' | 'faSignalLight' | 'faCheckLight' | 'faPresentationScreenLight' | 'faShareLight' | 'faUserCircleLight' | 'faBellLight' | 'faBugLight' | 'faLockLight' | 'faEyeLight' | 'faTrashCanLight' | 'faArrowUpLight' | 'faXmarkLight' | 'faQuestionLight' | 'faKeyLight' | 'faTableCellsLight' | 'faClockRotateLeftLight' | 'faHeartLight' | 'faChevronLeftLight' | 'faCloseLight' | 'faCircleInfoLight' | 'faPlayLight' | 'faPrintLight' | 'faTriangleExclamationLight' | 'faUserGroupLight' | 'faChevronRightLight' | 'faFileLinesLight' | 'faCopyLight' | 'faChartPieLight' | 'faGlobeLight' | 'faForwardLight' | 'faCircleXmarkLight' | 'faUploadLight' | 'faFileLight' | 'faBellSlashLight' | 'faChevronUpLight' | 'faMoneyBillLight' | 'faBuildingLight' | 'faTableLight' | 'faMapLight' | 'faDollarLight' | 'faDownloadLight' | 'faInfoLight' | 'faChartBarLight' | 'faSearchLight' | 'faPlusLight' | 'faTagLight' | 'faHomeLight' | 'faChartColumnLight' | 'faPhoneLight' | 'faChartLineLight' | 'faCheckCircleLight' | 'faHouseLight' | 'faPencilLight' | 'faWarningLight' | 'faMegaphoneLight' | 'faCircleUserLight' | 'faCreditCardLight' | 'faUnlockLight' | 'faArrowLeftLight' | 'faDollarSignLight' | 'faFlagCheckeredLight' | 'faCameraLight' | 'faPaperclipLight' | 'faCircleQuestionLight' | 'faPaletteLight' | 'faFilterLight' | 'faStarLight' | 'faServerLight' | 'faTrashLight' | 'faVideoLight' | 'faBullseyeLight' | 'faRotateLight' | 'faArrowRightLight' | 'faFlagLight' | 'faCommentsLight' | 'faEditLight' | 'faSpinnerLight' | 'faTrophyLight' | 'faImageLight' | 'faPenLight' | 'faExclamationLight' | 'faArrowTrendUpLight' | 'faClockLight' | 'faHistoryLight' | 'faThumbsUpLight' | 'faPaperPlaneLight' | 'faCommentLight' | 'faMagnifyingGlassLight' | 'faRocketLight';
...
export const iconData: Record<IconName, IconData> = {
  ...
  "faTrashLight": {
    "width": 448,
    "height": 512,
    "path": "M177.7 32h92.5c5.5 0 10.6 2.8 13.6 7.5L299.1 64H148.9l15.3-24.5c2.9-4.7 8.1-7.5 13.6-7.5zM336.9 64L311 22.6C302.2 8.5 286.8 0 270.3 0H177.7C161.2 0 145.8 8.5 137 22.6L111.1 64H64.1 32 16C7.2 64 0 71.2 0 80s7.2 16 16 16H34.3L59.8 452.6C62.1 486.1 90 512 123.6 512H324.4c33.6 0 61.4-25.9 63.8-59.4L413.7 96H432c8.8 0 16-7.2 16-16s-7.2-16-16-16H416 383.9 336.9zm44.8 32L356.3 450.3C355.1 467 341.2 480 324.4 480H123.6c-16.8 0-30.7-13-31.9-29.7L66.4 96H381.6z",
