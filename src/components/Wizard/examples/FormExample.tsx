    ...
    return (
      <div className="p-6 max-w-4xl mx-auto">
        <div className="flex items-center justify-center h-64">
          ...
          <p className="ml-3 text-lg">Creating campaign...</p>
        </div>
      </div>
    );
  }
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className={`mt-1 block w-full rounded-md border ${
                  getFieldError('businessGoal') ? 'border-red-300' : 'border-gray-300'
                } shadow-sm p-2`}
                placeholder="Describe your business goal"
              />
              {getFieldError('businessGoal') && (
                <p className="mt-1 text-sm text-red-600">{getFieldError('businessGoal')}</p>
              )}
            </div>
            ...
            {/* Primary KPI */}
            <div>
              <label htmlFor="primaryKPI" className="block text-sm font-medium text-gray-700">
                Primary KPI
              </label>
              <select
                name="primaryKPI"
        ...
        <div className="bg-white shadow-sm rounded-lg p-6">
          ...
          <div className="space-y-4">
            {/* Contact Name */}
            <div>
              <label htmlFor="primaryContact.name" className="block text-sm font-medium text-gray-700">
                Contact Name*
              </label>
              <input
                type="text"
            ...
            {/* Contact Email */}
            <div>
              <label htmlFor="primaryContact.email" className="block text-sm font-medium text-gray-700">
                Email*
              </label>
              <input
                type="email"
            ...
            {/* Contact Phone */}
            <div>
              <label htmlFor="primaryContact.phone" className="block text-sm font-medium text-gray-700">
                Phone
              </label>
              <input
                type="tel"
            ...
            {/* Contact Position */}
            <div>
              <label htmlFor="primaryContact.position" className="block text-sm font-medium text-gray-700">
                Position
              </label>
              <select
        ...
        <div className="bg-white shadow-sm rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="budget.total" className="block text-sm font-medium text-gray-700">
                  Total Budget*
                </label>
                <input
                  type="number"
        ...
        {/* Platform & Influencer */}
        <div className="bg-white shadow-sm rounded-lg p-6">
          <h2 className="text-xl font-semibold mb-4">Platform & Influencer</h2>
          
          <div className="space-y-4">
            {/* Platform */}
            <div>
              <label htmlFor="influencers[0].platform" className="block text-sm font-medium text-gray-700">
                Platform
              </label>
              <select
            ...
            {/* Influencer Handle */}
            <div>
              <label htmlFor="influencers[0].handle" className="block text-sm font-medium text-gray-700">
                Influencer Handle*
              </label>
