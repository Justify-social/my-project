...
export default function ScreeningQuestions({ selectedTags, onChange }: ScreeningQuestionsProps) {
  ...
  return (
    <div className="mb-4 relative font-body">
      <label className="block font-semibold mb-1 font-body">Search Screening Questions</label>
      <input
        type="text"
