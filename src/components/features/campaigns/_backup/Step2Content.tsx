  ...
  return (
    <div className="mb-5">
      ...
      <div className="relative">
        ...
        {/* Error message rendering will need to be handled via react-hook-form */}
      </div>
    </div>
  );
};
...
function FormContent() {
  ...
  useEffect(() => {
    if (campaignData && !hasLoadedData) {
      ...
      const safeMessaging: MessagingData =
        typeof messaging === 'object' && messaging !== null ? (messaging as MessagingData) : {};
  ...
  const handleSubmit = async (values: any) => {
    try {
      ...
      const transformedValues = {
        ...
        secondaryKPIs:
          values.secondaryKPIs?.map((kpi: string) => EnumTransformers.kpiToBackend(kpi)) || [],
        features:
          values.features?.map((feature: string) => EnumTransformers.featureToBackend(feature)) ||
          [],
      };
  ...
  const handleSaveDraft = async (values: any) => {
    try {
      ...
      console.log(
        `Making PATCH request to /api/campaigns/${currentCampaignId} with draft data:`,
    ...
    return (
      <div className="p-4 bg-red-50 border border-red-200 rounded-md font-work-sans">
        ...
        <button
          ...
          className="mt-4 btn btn-secondary font-work-sans"
        >
          Return to Campaigns
        </button>
      </div>
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 pb-16 bg-background font-work-sans">
      <h1 className="text-2xl font-bold mb-6 font-heading">Campaign Creation</h1>
      <Formik
        enableReinitialize
          ...
          <Form className="space-y-8">
            <div className="bg-background rounded-xl p-6 shadow-sm border font-work-sans">
              ...
              <p className="mb-4 text-sm text-muted-foreground font-work-sans">
                Select 1 Primary KPI and up to 4 Secondary KPIs. A Primary KPI cannot be selected as
                a Secondary KPI.
              </p>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm border font-work-sans">
              ...
              <div className="mt-4 grid grid-cols-2 gap-6 font-work-sans">
                <div className="font-work-sans">
                  <h3 className="text-md font-medium mb-2 font-heading">Primary KPI</h3>
                  <div className="grid grid-cols-1 gap-2 font-work-sans">
                    {values.primaryKPI && (
                      <div className="bg-accent p-2 rounded border border-accent/40 flex items-center text-accent-foreground font-work-sans">
                        <div className="w-5 h-5 mr-2 filter brightness-0 invert font-work-sans">
                          <Image
                            src={
                              kpis.find(k => k.key === values.primaryKPI)?.icon ||
                              '/icons/kpis/Ad_Recall.svg'
                            }
                            alt="Primary KPI"
                            width={20}
                            height={20}
                ...
                <div className="font-work-sans">
                  <h3 className="text-md font-medium mb-2 font-heading">
                    Secondary KPIs{' '}
                    {Array.isArray(values.secondaryKPIs) &&
                      values.secondaryKPIs.length > 0 &&
                      `(${values.secondaryKPIs.length})`}
                  </h3>
                  <div className="grid grid-cols-1 gap-2 font-work-sans">
                    {(values.secondaryKPIs ?? []).map((kpiKey: KPI) => {
                      ...
                      return (
                        <div
                          key={kpiKey}
                          className="bg-muted/50 p-2 rounded border flex items-center font-work-sans"
                        >
                          ...
                          <span className="flex-grow font-work-sans">
                          ...
                          <IconButtonAction
                            ...
                            onClick={() => {
                              ...
                              const updatedKpis = currentKPIs.filter(
                                (k: KPI): k is KPI => k !== kpiKey
                              );
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm border font-work-sans">
              <h2 className="text-xl font-semibold mb-4 flex items-center font-heading">
              ...
              <div className="space-y-4 font-work-sans">
                ...
                <StyledField
                  ...
                  name="memorability"
                  required
                  icon={<Icon iconId="faStarLight" className="h-5 w-5" />}
                ...
                <StyledField
                  ...
                  name="keyBenefits"
                  required
                  icon={<Icon iconId="faCircleCheckLight" className="h-5 w-5" />}
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm border font-work-sans">
              ...
              <div className="space-y-4 font-work-sans">
                <StyledField
                  ...
                  rows={2}
                  required
                  icon={<Icon iconId="faArrowTrendUpLight" className="h-5 w-5" />}
                ...
                <StyledField
                  ...
                  rows={2}
                  required
                  icon={<Icon iconId="faDollarSignLight" className="h-5 w-5" />}
                ...
                <StyledField
                  ...
                  as="textarea"
                  rows={2}
                  icon={<Icon iconId="faChartBarLight" className="h-5 w-5" />}
                    ...
                    <div className="flex justify-end mt-3 font-work-sans">
                      ...
                      {!(
                        Array.isArray(values.features) && values.features.includes(feature.key)
                          ...
                          <div className="text-muted-foreground text-xs font-work-sans">
                            Click to select
                          </div>
                        )}
                    </div>
            ...
            <ProgressBar
              currentStep={2}
              onStepClick={step =>
                router.push(`/campaigns/wizard/step-${step}?id=${campaignId || (data as any)?.id}`)
              }
              onBack={() =>
                router.push(`/campaigns/wizard/step-1?id=${campaignId || (data as any)?.id}`)
              }
