...
function FormContent() {
  ...
  useEffect(() => {
    if (campaignData && hasLoadedData) {
      ...
      // Safely access messaging properties with explicit checks
      ...
      const formInitialValues = {
        ...
        // Use the safely accessed messaging object
              ...
              {features.map((feature) =>
                <div
                  ...
                  <div className="flex justify-end mt-3 font-work-sans">
                    {Array.isArray(values.features) && values.features.includes(feature.key) &&
                      <Icon iconId="faCheckCircleSolid" className="w-5 h-5 text-white" />
                    }
                    {!(Array.isArray(values.features) && values.features.includes(feature.key)) &&
