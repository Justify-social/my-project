...
import WarningIcon from '../../ui/icons/variants/IconVariants';
import PaginationButton from '../../ui/pagination/styles/pagination.styles';
...
const MembersList: React.FC<MembersListProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center py-10">
        <Icon name="faSpinner" spin className="text-[#00BFFF] text-3xl animate-spin" />
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center h-40 text-center">
        <div className="flex items-center text-red-500 mb-2">
          <WarningIcon name="faTriangleExclamation" size="lg" className="mr-3" />
  ...
  if (members.length === 0 && invitations.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-40 text-center">
        <StaticIcon name="faUsersSlash" size="3xl" className="text-gray-400 mb-4" />
      ...
      <div className="flex justify-between mb-4">
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
            <StaticIcon name="faSearch" size="md" className="text-[#4A5568]" />
          </div>
          <input
            type="text"
            ...
            <tr>
              ...
              >
                <div className="flex items-center">
                  ...
                  {sortField === 'name' && (
                    <Icon 
                      name={sortDirection === 'asc' ? 'faArrowUp' : 'faArrowDown'} 
                      size="sm" 
                      className="ml-1" 
                    />
                  )}
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-[#4A5568]">
                      <select
                        ...
                        className="border border-[#D1D5DB] rounded px-2 py-1 text-sm focus:ring-[#00BFFF] focus:border-[#00BFFF]"
                      >
