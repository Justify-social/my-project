...
export default function PlatformSwitcher({
  ...
  return (
    <div className="flex flex-col space-y-2 font-work-sans">
      <h3 className="text-sm font-medium text-gray-700 font-sora">Platform Preview</h3>
      <div className="flex space-x-2 font-work-sans">
        ...
        <button
          ...
          'bg-gray-100 text-gray-700 hover:bg-gray-200'} font-work-sans`
          }>

            <span className="mr-2 font-work-sans">{platformConfig[platform].icon}</span>
            <span className="font-work-sans">{platform}</span>
          </button>
        )}
      </div>
    </div>);
