    ...
    <div className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Icon name="faFont" className="text-[#4A5568]" />
            </div>
            <select
              id="font-family"
              value={selectedFont}
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
              <Icon name="faChevronDown" className="text-[#4A5568]" />
            </div>
          </div>
          {fontError && (
            <motion.p 
        ...
        <div>
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <Icon name="faTextSize" className="text-[#4A5568]" />
            </div>
            <select
              id="font-size"
      ...
      {/* Font preview */}
      <div className="mt-6 p-4 border border-[#D1D5DB] rounded-lg bg-white">
        <p className="text-sm text-[#4A5568] mb-2">Preview:</p>
        <div 
          className="p-3 bg-gray-50 rounded min-h-[60px] flex items-center justify-center"
          style={{ 
