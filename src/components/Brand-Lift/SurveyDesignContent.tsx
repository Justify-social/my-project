...
export default function SurveyDesignContent() {
  ...
  return <div className="container mx-auto px-4 py-8 bg-[var(--background-color)] mobile-optimize">
      <div className="mb-8">
      ...
      <div className="mb-8">
        ...
        <div className={`bg-[var(--background-color)] rounded-lg border border-[var(--divider-color)] p-6 question-builder-form ${editingQuestion ? 'border-[var(--accent-color)] shadow-md' : ''}`}>
          ...
          <div className="mb-6 relative">
            ...
            <input type="text" className="w-full pl-10 p-2 border border-[var(--divider-color)] rounded-md font-['Work_Sans'] text-[var(--primary-color)]" placeholder="Search a design question" aria-label="Search design questions" />
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="md:col-span-3">
                <input type="text" className="w-full p-2 border border-[var(--divider-color)] rounded-md font-['Work_Sans'] text-[var(--primary-color)]" placeholder="Type the question title here" value={newQuestion.title} onChange={e => setNewQuestion({
                ...newQuestion,
              ...
              <div>
                <div className="relative">
                  <select className="w-full p-2 border border-[var(--divider-color)] rounded-md appearance-none font-['Work_Sans'] text-[var(--primary-color)]" value={newQuestion.type} onChange={e => setNewQuestion({
                  ...newQuestion,
          ...
          <div className="mb-4">
            ...
            {newQuestion.options.map((option, index) => <div key={option.id} className="mb-3">
                <div className="flex mb-2">
                  <div className="relative flex-grow">
                    <input type="text" className="w-full p-2 border border-[var(--divider-color)] rounded-l-md font-['Work_Sans'] text-[var(--primary-color)]" placeholder="Type your answer" value={option.text} onChange={e => updateOptionText(option.id, e.target.value)} />

                    {option.text && <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[var(--accent-color)] text-white rounded-full p-1.5 hover:opacity-90 transition-opacity" onClick={() => openGiphyModal(index)} title="Add GIF" aria-label="Add GIF">
            ...
            <button className="bg-red-100 text-red-600 px-4 py-2 rounded-r-md hover:bg-red-200 flex items-center justify-center border-t border-r border-b border-[var(--divider-color)]" onClick={() => removeOption(option.id)}>
                ...
                {option.image ? <div className="aspect-square relative w-full h-32 sm:h-40">
                    <Image src={option.image} alt={option.text || 'Answer option'} fill unoptimized={true} className="object-cover" loading="lazy" />

                    <button className="absolute top-2 right-2 bg-red-500 text-white rounded-full p-1 hover:bg-red-600" onClick={() => removeImage(option.id)}>
                  ...
                  </div> : <div className="relative aspect-square flex items-center justify-center w-full h-32 sm:h-40 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-all duration-200 rounded-md border border-dashed border-gray-300">
                    <button onClick={() => openGiphyModal(index)} className="flex flex-col items-center justify-center text-[var(--secondary-color)] w-full h-full">
            ...
            <button className="px-4 py-2 border border-[var(--divider-color)] rounded-md text-[var(--primary-color)] font-medium font-['Work_Sans'] hover:bg-gray-50 mt-2 flex items-center" onClick={addOption}>
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1 font-['Work_Sans'] text-[var(--primary-color)] flex items-center">
              ...
              <span className="inline-block ml-1 relative">
                <svg className="h-4 w-4 text-[var(--secondary-color)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" onMouseEnter={e => {
                ...
                {showKpiTooltip === 'kpi-builder-tooltip' && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
            ...
            <select className="w-full p-2 border border-[var(--divider-color)] rounded-md font-['Work_Sans'] text-[var(--primary-color)]" value={questionKpi} onChange={e => setQuestionKpi(e.target.value)}>
          ...
          <div className="mb-4">
            ...
            <div className="flex space-x-6">
              <label className="flex items-center relative">
                <input type="checkbox" className="form-checkbox h-4 w-4 text-[var(--accent-color)]" checked={isRandomized} onChange={e => setIsRandomized(e.target.checked)} />
                ...
                {showKpiTooltip === 'randomise-tooltip' && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
                left: `${tooltipPosition.x}px`,
                top: `${tooltipPosition.y}px`,
                position: 'fixed'
              }}>
              ...
              <label className="flex items-center relative">
                <input type="checkbox" className="form-checkbox h-4 w-4 text-[var(--accent-color)]" checked={isMandatory} onChange={e => setIsMandatory(e.target.checked)} />
                ...
                {showKpiTooltip === 'mandatory-tooltip' && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
                left: `${tooltipPosition.x}px`,
                top: `${tooltipPosition.y}px`,
                position: 'fixed'
              }}>
          ...
          <div className="flex space-x-4 mt-6">
            <button onClick={handleClearForm} className="flex-1 py-2 bg-red-500 text-white rounded-md font-medium font-['Work_Sans'] hover:bg-red-600 transition-colors flex items-center justify-center">

              <Icon name="faTrash" className="mr-2 h-5 w-5" solid={false} />
              Clear Form
            </button>
            <button onClick={handleAddQuestion} className="flex-1 py-2 bg-[var(--accent-color)] text-white rounded-md font-medium font-['Work_Sans'] hover:opacity-90 transition-opacity flex items-center justify-center">
      ...
      <div className="mb-8">
        ...
        <div className="mb-4">
          ...
          <div className="text-sm text-[var(--secondary-color)] font-['Work_Sans']">
            ...
            <span className="font-medium inline-block ml-1 relative">
              <span className="cursor-help border-b border-dotted border-[var(--accent-color)]" onMouseEnter={e => {
              updateTooltipPosition(e);
              ...
              {showKpiTooltip === 'brand-awareness' && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
              left: `${tooltipPosition.x}px`,
              top: `${tooltipPosition.y}px`,
              position: 'fixed'
            }}>
            ...
            <span className="font-medium relative inline-block ml-1">
              ...
              {showKpiTooltip === 'ad-recall' && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
              left: `${tooltipPosition.x}px`,
              top: `${tooltipPosition.y}px`,
              position: 'fixed'
            }}>
            ...
            {showKpiTooltip === 'brand-preference' && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
            left: `${tooltipPosition.x}px`,
            top: `${tooltipPosition.y}px`,
            position: 'fixed'
          }}>
            ...
            {showKpiTooltip === 'action-intent' && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
            left: `${tooltipPosition.x}px`,
            top: `${tooltipPosition.y}px`,
            position: 'fixed'
          }}>
        ...
        <div className="space-y-6">
          {questions.map((question, index) => <div key={question.id} className="border border-[var(--divider-color)] rounded-lg overflow-hidden transition-all duration-300 hover:shadow-md" draggable onDragStart={e => handleDragStart(e, index, question.id)} onDragEnd={handleDragEnd} onDragOver={e => handleDragOver(e, index, question.id)} onDragLeave={handleDragLeave} onDrop={handleDrop}>

              <div className="flex items-center p-4 border-b border-[var(--divider-color)] bg-gray-50 cursor-pointer" onClick={() => toggleQuestionExpansion(question.id)}>

                <div className="flex-1">
                  <div className="flex items-center">
                    <button className="mr-4 text-[var(--secondary-color)] cursor-move" title="Drag to reorder" onClick={e => e.stopPropagation()}>

                      <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
                      </svg>
                    </button>
                    <button className="mr-4 text-[var(--secondary-color)]" onClick={e => {
                  e.stopPropagation();
                  toggleQuestionExpansion(question.id);
                    ...
                    <div className="relative flex items-center">
                      <div className="text-sm text-[var(--accent-color)] font-['Work_Sans'] flex items-center">
                        ...
                        <span className="cursor-help inline-block ml-1" onMouseEnter={e => {
                      updateTooltipPosition(e);
                      ...
                      {showKpiTooltip === `kpi-${question.id}` && <div className="absolute z-[9999] w-72 p-4 bg-white border border-[var(--divider-color)] rounded-lg shadow-lg" style={{
                    left: `${tooltipPosition.x}px`,
                    top: `${tooltipPosition.y}px`,
                    position: 'fixed'
                  }}>
                ...
                <div className="flex items-center space-x-2">
                  <button onClick={() => handleDeleteQuestion(question.id)} className="text-red-500 hover:text-red-700 p-1 rounded hover:bg-gray-100">
              ...
              {expandedQuestions[question.id] && <div className="p-4 bg-white">
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="md:col-span-3">
                      <input type="text" className="w-full p-2 border border-[var(--divider-color)] rounded-md font-['Work_Sans'] text-[var(--primary-color)]" value={question.title} onChange={e => {
                    ...
                    setQuestions(updatedQuestions);
                      ...
                      <div>
                        <div className="relative">
                          <select className="w-full p-2 border border-[var(--divider-color)] rounded-md appearance-none font-['Work_Sans'] text-[var(--primary-color)]" value={question.type} onChange={e => {
                      const updatedQuestions = questions.map(q => q.id === question.id ? {
                        ...q,
                        type: e.target.value as 'Multiple Choice' | 'Single Choice'
                      } : q);
                  ...
                  <div className="mb-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                      {question.options.map((option, optionIndex) => <div key={option.id} className={`relative cursor-pointer transition-all duration-300 transform hover:scale-105 rounded-lg overflow-hidden ${isOptionSelected(question.id, option.id) ? 'ring-2 ring-[var(--accent-color)] border-transparent shadow-md' : 'border border-[var(--divider-color)] hover:shadow-md'}`} onClick={() => toggleAnswerSelection(question.id, option.id)} draggable onDragStart={e => handleOptionDragStart(e, question.id, optionIndex, option.id)} onDragEnd={handleOptionDragEnd} onDragOver={e => handleOptionDragOver(e, question.id, optionIndex, option.id)} onDragLeave={handleOptionDragLeave} onDrop={e => handleOptionDrop(e, question.id)}>
                          ...
                          {option.image ? <div className="aspect-square relative w-full h-32 sm:h-40 group">
                              ...
                              {isOptionSelected(question.id, option.id) && <div className="absolute top-2 left-2 bg-[var(--accent-color)] rounded-full p-0.5 animate-pulse">
                    ...
                    <button className="absolute bottom-2 right-2 bg-[var(--accent-color)] text-white rounded-full p-1.5 hover:opacity-90 hover:scale-110 transition-all opacity-0 group-hover:opacity-100 shadow-md" onClick={e => {
                      e.stopPropagation();
                      changeOptionGif(question.id, option.id);
                            ...
                            </div> : <div className="aspect-square flex items-center justify-center w-full h-32 sm:h-40 cursor-pointer hover:bg-gray-100 transition-all duration-300 relative group bg-gray-50 border border-dashed border-gray-300 rounded-md">
                              <button onClick={e => {
                      e.stopPropagation();
                      changeOptionGif(question.id, option.id);
                          ...
                          <div className="p-2 text-sm text-[var(--primary-color)] font-medium overflow-hidden">
                            <input type="text" className="w-full p-1 border-b border-transparent hover:border-[var(--divider-color)] focus:border-[var(--accent-color)] outline-none bg-transparent" value={option.text} onChange={e => {
                      const updatedQuestions = questions.map(q => {
                        if (q.id === question.id) {
                  ...
                  <div className="mt-6 pt-4 border-t border-[var(--divider-color)]">
                    ...
                    <div className="flex flex-wrap gap-6">
                      <label className="flex items-center relative">
                        <input type="checkbox" className="form-checkbox h-4 w-4 text-[var(--accent-color)]" checked={question.isRandomized || false} onChange={() => toggleQuestionRandomize(question.id)} />
                        ...
                        {showKpiTooltip === `randomise-${question.id}` && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
                    left: `${tooltipPosition.x}px`,
                    top: `${tooltipPosition.y}px`,
                    position: 'fixed'
                  }}>
                      ...
                      <label className="flex items-center relative">
                        <input type="checkbox" className="form-checkbox h-4 w-4 text-[var(--accent-color)]" checked={question.isMandatory || false} onChange={() => toggleQuestionMandatory(question.id)} />
                        ...
                        {showKpiTooltip === `mandatory-${question.id}` && <div className="absolute z-[9999] w-64 p-3 bg-white rounded-md shadow-lg border border-[var(--divider-color)] text-xs" style={{
                    left: `${tooltipPosition.x}px`,
                    top: `${tooltipPosition.y}px`,
                    position: 'fixed'
                  }}>
        ...
        <div className="mt-8 flex justify-end">
          <button onClick={handlePreview} className="px-6 py-2 bg-[var(--accent-color)] text-white rounded-md font-medium font-['Work_Sans'] hover:opacity-90 transition-opacity">
      ...
      {/* Giphy Search Modal */}
      {showGiphyModal && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 animate-fadeIn" aria-modal="true" role="dialog" aria-labelledby="giphy-modal-title">
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] overflow-hidden animate-scaleIn">
            ...
            <div className="p-4 border-b border-[var(--divider-color)]">
              <div className="flex">
                <input type="text" className="flex-grow p-2 border border-[var(--divider-color)] rounded-l-md font-['Work_Sans'] text-[var(--primary-color)]" placeholder="Search for GIFs..." value={giphySearchTerm} onChange={e => setGiphySearchTerm(e.target.value)} onKeyPress={e => e.key === 'Enter' && searchGiphy(giphySearchTerm)} aria-label="Search for GIFs" />

                    <button className="bg-[var(--accent-color)] text-white px-4 py-2 rounded-r-md font-medium font-['Work_Sans'] hover:opacity-90 transition-opacity" onClick={() => searchGiphy(giphySearchTerm)} aria-label="Search Giphy">
          ...
          maxHeight: '50vh'
              ...
              {isSearching ? <div className="flex justify-center items-center h-40">
                  <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[var(--accent-color)]"></div>
                </div> : giphyResults.length === 0 ? <div className="text-center py-10 text-[var(--secondary-color)] font-['Work_Sans']">
                  ...
                  {giphyResults.map(gif => <div key={gif.id} className="cursor-pointer border border-[var(--divider-color)] rounded-md overflow-hidden hover:border-[var(--accent-color)] transition-all duration-300 transform hover:scale-105 hover:shadow-md" onClick={() => selectGif(gif.images.original.url)} tabIndex={0} role="button" aria-label={`Select ${gif.title || "GIF"}`} onKeyPress={e => e.key === 'Enter' && selectGif(gif.images.original.url)}>

                      <Image src={gif.images.fixed_height.url} alt={gif.title || "GIF"} width={200} height={200} unoptimized={true} className="w-full h-24 object-cover transition-all duration-300 hover:brightness-110" loading="lazy" />
            ...
            <div className="p-4 border-t border-[var(--divider-color)] flex justify-between">
              <button className="px-4 py-2 border border-[var(--divider-color)] bg-white text-[var(--primary-color)] rounded font-medium font-['Work_Sans'] text-sm hover:bg-gray-50 transition-colors" onClick={() => setShowGiphyModal(false)} aria-label="Cancel GIF selection">
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
            <div className="p-6">
              ...
              <div className="flex justify-center space-x-4">
                <button className="px-6 py-2 bg-gray-200 text-[var(--secondary-color)] rounded-md font-medium font-['Work_Sans'] hover:bg-gray-300 transition-colors" onClick={() => setShowDeleteModal(false)}>

                  Cancel
                </button>
                <button className="px-6 py-2 bg-red-500 text-white rounded-md font-medium font-['Work_Sans'] hover:bg-red-600 transition-colors" onClick={() => questionToDelete && handleDeleteQuestion(questionToDelete)}>
