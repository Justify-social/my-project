...
// Define paths for icon directories
const lightIconsPath = path.join(process.cwd(), 'public', 'ui-icons', 'light');
const solidIconsPath = path.join(process.cwd(), 'public', 'ui-icons', 'solid');
