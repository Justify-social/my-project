  ...
  return <div className="container mx-auto p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <FontAwesomeIcon icon={faUser} className="w-10 h-10 text-blue-600" solid={false} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <FontAwesomeIcon icon={faHouse} className="w-10 h-10 text-green-600" solid={false} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <FontAwesomeIcon icon={falUser} className="w-10 h-10 text-purple-600" solid={false} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <FontAwesomeIcon icon={faTwitter} className="w-10 h-10 text-blue-400" solid={false} />
            </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <FontAwesomeIcon icon={['fas', 'user']} className="w-10 h-10 text-red-600" solid={false} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <FontAwesomeIcon icon={['fas', 'house']} className="w-10 h-10 text-amber-600" solid={false} />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <FontAwesomeIcon icon={['fab', 'twitter']} className="w-10 h-10 text-sky-500" solid={false} />
            </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <i className="fa-solid fa-user w-10 h-10 text-indigo-600" style={{
              fontSize: '2.5rem'
            }}></i>
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <i className="fa-light fa-user w-10 h-10 text-teal-600" style={{
              fontSize: '2.5rem'
            }}></i>
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="p-4 bg-gray-50 rounded-md flex items-center justify-center">
              <i className="fa-brands fa-twitter w-10 h-10 text-cyan-500" style={{
              fontSize: '2.5rem'
            }}></i>
            </div>
