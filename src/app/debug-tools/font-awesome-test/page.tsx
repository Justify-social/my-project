            ...
            {set.icons.map((icon, iconIndex) => (
              <div key={iconIndex} className="flex flex-col items-center p-4 border rounded bg-white hover:shadow-md transition">
                <div className="w-16 h-16 flex items-center justify-center mb-2 bg-gray-50 rounded">
                  <i className={`${set.prefix} ${icon} text-3xl text-blue-500`}></i>
                </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div className="p-4 border rounded bg-white">
            <div className="flex items-start mb-6">
              <div className="mr-4 p-2 bg-gray-50 rounded">
                <i className="fa-light fa-circle-info w-6 h-6 text-[#00BFFF]"></i>
              </div>
              <div>
          ...
          <div className="p-4 border rounded bg-white">
            <div className="flex items-start mb-6">
              <div className="mr-4 p-2 bg-gray-50 rounded">
                <i className="fa-light fa-users w-6 h-6 text-[#00BFFF]"></i>
              </div>
              <div>
          ...
          <div className="p-4 border rounded bg-white">
            <div className="flex items-start mb-6">
              <div className="mr-4 p-2 bg-gray-50 rounded">
                <i className="fa-light fa-paint-brush w-6 h-6 text-[#00BFFF]"></i>
              </div>
              <div>
            ...
            {[
              ...
              return (
                <button 
                  ...
                  `}
                >
                  <i className={`${isActive ? 'fa-solid' : 'fa-light'} ${tab.icon.split(' ')[1]} w-5 h-5 mr-2`}></i>
