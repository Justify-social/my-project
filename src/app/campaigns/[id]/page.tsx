    ...
    if (platformIcon && title === "Platform") {
      if (typeof value === 'string') {
        ...
        if (platform.includes('instagram')) {
          return <Image src="/ui-icons/brands/instagram.svg" width={24} height={24} alt="Instagram" />;
        } else if (platform.includes('facebook')) {
          return <Image src="/ui-icons/brands/facebook.svg" width={24} height={24} alt="Facebook" />;
        } else if (platform.includes('twitter') || platform.includes('x')) {
          return <Image src="/ui-icons/brands/x-twitter.svg" width={24} height={24} alt="Twitter" />;
        } else if (platform.includes('tiktok')) {
          return <Image src="/ui-icons/brands/tiktok.svg" width={24} height={24} alt="TikTok" />;
        } else if (platform.includes('youtube')) {
          return <Image src="/ui-icons/brands/youtube.svg" width={24} height={24} alt="YouTube" />;
        } else if (platform.includes('linkedin')) {
          return <Image src="/ui-icons/brands/linkedin.svg" width={24} height={24} alt="LinkedIn" />;
        } else if (platform.includes('pinterest')) {
          return <Image src="/ui-icons/brands/pinterest.svg" width={24} height={24} alt="Pinterest" />;
        } else if (platform.includes('reddit')) {
          return <Image src="/ui-icons/brands/reddit.svg" width={24} height={24} alt="Reddit" />;
        }
      }
    }
    return (
        ...
        <div className="mb-6 font-work-sans">
          <DataCard title="Creative Assets" iconName="photo" description="Campaign creative assets" actions={<button className="text-sm text-[var(--accent-color)] hover:text-[var(--accent-color)] hover:underline font-work-sans">View All</button>}>
            {error ? <div className="text-center py-10 text-[var(--secondary-color)] font-work-sans">
              ...
              <div>
                {data?.creativeAssets && Array.isArray(data.creativeAssets) && data.creativeAssets.length > 0 ? 
