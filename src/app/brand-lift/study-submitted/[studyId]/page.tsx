    ...
    return (
        <div className="container mx-auto p-4 md:p-6 flex flex-col items-center justify-center min-h-[calc(100vh-200px)] text-center bg-background">
            ...
            {!isLoading && !error && studyDetails && (
                <>
                    <Icon iconId="faCircleCheckSolid" className="w-16 h-16 md:w-20 md:h-20 text-accent mb-8 drop-shadow-lg" />
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 tracking-tight text-primary">Study Submitted!</h1>
                    ...
                    <p className="text-base sm:text-lg text-muted-foreground max-w-xl mb-4 px-2">
                        Your Brand Lift Study "<span className="font-semibold text-foreground">{studyDetails.name || 'this study'}</span>" has been successfully submitted.
                        Our Success Team is now processing your study, and your report will be delivered via email. Thank you!
                    </p>
                    <p className="text-sm text-muted-foreground mt-2 mb-8 max-w-xl px-2">
                        Any questions - reach out by email: <a href="mailto:hello@justify.social" className="underline hover:text-accent transition-colors">hello@justify.social</a>
                    </p>
