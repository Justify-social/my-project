...
const SimpleWordCloud: React.FC = () => {
  ...
  return (
    <div className="bg-white p-4 rounded-lg font-work-sans">
...
const KeyMetricsAtAGlance: React.FC<{metrics: KeyMetric[];}> = ({ metrics }) => {
  ...
  return (
    <motion.div
      ...
      <div
        key={metric.label}
        className="bg-white border border-gray-100 rounded-lg p-5 flex flex-col items-start font-work-sans">

          <div className="flex items-center justify-between w-full mb-1 font-work-sans">
            <div className="flex items-center font-work-sans">
              <span className={`kpi-icon ${getKpiClass(metric.label)} font-work-sans`}></span>
              <p className="text-sm font-medium font-work-sans" style={{ color: 'var(--secondary-color)' }}>{metric.label}</p>
            </div>
            {/* Info icon with tooltip */}
            <div className="relative group font-work-sans">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400 cursor-pointer hover:text-gray-600 font-work-sans" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
              <div className="absolute z-10 invisible group-hover:visible bg-gray-800 text-white text-xs rounded p-2 w-48 right-0 top-6 font-work-sans">
                Additional details about {metric.label.toLowerCase()} measurement and what it means for your brand.
              </div>
            </div>
          </div>
          <h3 className="text-3xl font-bold font-sora" style={{ color: 'var(--accent-color)' }}>
            +{metric.points}pts
          </h3>
          {metric.description &&
        <p className="text-xs mt-2 font-work-sans" style={{ color: 'var(--secondary-color)', opacity: 0.8 }}>{metric.description}</p>
        }
        </div>
      )}
    </motion.div>);
...
<div className="bg-white rounded-lg border border-gray-100 p-6 font-work-sans">
    <h3 className="text-lg font-medium mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>{title}</h3>
    <div className="h-[300px] font-work-sans">
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-6 font-work-sans">
      <div className="flex items-center justify-between mb-6 font-work-sans">
        <div className="flex items-center font-work-sans">
          <span className="kpi-icon kpi-message-association font-work-sans"></span>
          <h3 className="text-lg font-medium font-sora" style={{ color: 'var(--primary-color)' }}>
        Messaging Themes
          </h3>
        </div>
        <div className="relative group font-work-sans">
      ...
      <p className="text-sm mb-6 font-work-sans" style={{ color: 'var(--secondary-color)' }}>
...
const FunnelVisualisation: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-6 font-work-sans">
      ...
      {/* Vertical bar chart */}
      <div className="h-[400px] mt-6 font-work-sans">
        <Bar data={chartData} options={chartOptions as any} />
      </div>
      
      {/* Lift indicators below the chart */}
      <div className="grid grid-cols-3 gap-4 mt-8 font-work-sans">
        {metrics.map((metric) =>
        <div key={metric.name} className="bg-gray-50 p-4 rounded-lg font-work-sans">
            <div className="flex items-center mb-2 font-work-sans">
              <span className={`kpi-icon ${getKpiClass(metric.name)} font-work-sans`}></span>
              <span className="text-sm font-medium font-work-sans" style={{ color: 'var(--primary-color)' }}>
                {metric.name}
              </span>
            </div>
            <div className="flex justify-between items-center font-work-sans">
              <span className="text-xs font-work-sans" style={{ color: 'var(--secondary-color)' }}>
                Lift:
              </span>
              <span className="text-lg font-bold font-work-sans" style={{ color: 'green' }}>
...
const DemographicBreakdown: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-6 font-work-sans">
      ...
      {/* Filters */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 font-work-sans">
        <div className="font-work-sans">
          <label className="block text-sm font-medium mb-2 font-work-sans" style={{ color: 'var(--secondary-color)' }}>
            Age Group
          </label>
          <select
            className="w-full p-2 border border-gray-200 rounded-md font-work-sans"
        ...
        <div className="font-work-sans">
          ...
          <div className="flex gap-4 font-work-sans">
            <label className="flex items-center font-work-sans">
              <input
                type="checkbox"
              ...
              <span className="text-sm font-work-sans" style={{ color: 'var(--primary-color)' }}>Male</span>
            </label>
            <label className="flex items-center font-work-sans">
              <input
                type="checkbox"
              ...
              <span className="text-sm font-work-sans" style={{ color: 'var(--primary-color)' }}>Female</span>
            </label>
          </div>
        </div>
      ...
      {/* Metric Tabs */}
      <div className="flex border-b border-gray-200 mb-6 font-work-sans">
        ...
        <button
          ...
          'border-transparent hover:border-gray-300'} transition-colors font-work-sans`
          }
          onClick={() => setActiveMetric(metric)}
          aria-label={`View ${metric} metrics`}>

            <span className={`kpi-icon ${getKpiClass(metric)} font-work-sans`}></span>
            <span className="text-sm font-medium font-work-sans">{metric}</span>
          </button>
        )}
      </div>
      ...
      <div className="mt-4 text-xs text-center font-work-sans" style={{ color: 'var(--secondary-color)' }}>
...
const SurveyQuestions: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-6 font-work-sans">
      <h3 className="text-lg font-medium mb-6 font-sora" style={{ color: 'var(--primary-color)' }}>
        Survey Questions
      </h3>
      <p className="text-sm mb-6 font-work-sans" style={{ color: 'var(--secondary-color)' }}>
      ...
      <div className="space-y-4 font-work-sans">
        ...
        <div key={question.id} className="border border-gray-100 rounded-lg overflow-hidden font-work-sans">
            <div
            className="p-4 flex justify-between items-center cursor-pointer hover:bg-gray-50 font-work-sans"
            onClick={() => toggleQuestion(question.id)}>

              <div className="flex items-center font-work-sans">
                <span className={`kpi-icon ${getKpiClass(question.category)} font-work-sans`}></span>
                <div className="font-work-sans">
                  <p className="text-sm font-medium font-work-sans" style={{ color: 'var(--primary-color)' }}>
                    {question.text}
                  </p>
                  <div className="flex items-center mt-1 font-work-sans">
                    <span className="text-xs px-2 py-0.5 rounded-full mr-2 font-work-sans"
              ...
              className={`h-5 w-5 text-gray-400 transition-transform ${expandedQuestion === question.id ? 'transform rotate-180' : ''} font-work-sans`}
              viewBox="0 0 20 20"
              fill="currentColor"
          ...
          <div className="p-4 bg-gray-50 border-t border-gray-100 font-work-sans">
                <h5 className="text-xs font-medium mb-2 font-sora" style={{ color: 'var(--secondary-color)' }}>Response Options:</h5>
                <ul className="space-y-1 font-work-sans">
                  {question.category === 'Brand Awareness' &&
              <>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Very familiar</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Somewhat familiar</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Not very familiar</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Not at all familiar</li>
                    </>
              }
                  {question.category === 'Message Association' &&
              <>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• High quality</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Innovative</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Trustworthy</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Good value</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Environmentally friendly</li>
                    </>
              }
                  {question.category === 'Consideration' &&
              <>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Very likely</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Somewhat likely</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Neither likely nor unlikely</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Somewhat unlikely</li>
                      <li className="text-xs font-work-sans" style={{ color: 'var(--primary-color)' }}>• Very unlikely</li>
                    </>
              }
                  {question.type === 'Multiple Choice' &&
              <li className="text-xs mt-2 italic font-work-sans" style={{ color: 'var(--secondary-color)' }}>
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-100 p-6 font-work-sans">
      <div className="flex justify-between items-center mb-6 font-work-sans">
        <div className="flex items-center font-work-sans">
          <span className="kpi-icon kpi-brand-awareness font-work-sans"></span>
          <h3 className="text-lg font-medium font-sora" style={{ color: 'var(--primary-color)' }}>
            Trend Over Time
          </h3>
        </div>
...
const Recommendations: React.FC = () => {
  ...
  return (
    <div className="bg-blue-50 rounded-lg border border-blue-100 p-6 font-work-sans">
      <div className="flex items-start mb-6 font-work-sans">
        <div className="bg-blue-100 rounded-full p-2 mr-4 font-work-sans">
        ...
        <div className="font-work-sans">
          <h3 className="text-lg font-medium mb-1 font-sora" style={{ color: 'var(--primary-color)' }}>
            Recommendations
          </h3>
          <p className="text-sm font-work-sans" style={{ color: 'var(--secondary-color)' }}>
      ...
      <div className="space-y-4 font-work-sans">
        ...
        <div key={rec.id} className="flex items-start p-3 bg-white rounded-lg border border-gray-100 font-work-sans">
            <div className="mt-0.5 mr-3 font-work-sans">
              <input
              type="checkbox"
              checked={rec.completed}
              className="rounded text-blue-500 focus:ring-blue-500 font-work-sans"
              readOnly
            ...
            <div className="font-work-sans">
              ...
              <span className="inline-block px-2 py-0.5 mt-1 text-xs rounded-full font-work-sans"
            style={{ backgroundColor: 'rgba(59, 130, 246, 0.1)', color: 'var(--accent-color)' }}>
                {rec.category}
              </span>
            </div>
      ...
      <button
        className="mt-6 w-full py-2 text-sm font-medium rounded-md text-white font-work-sans"
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 font-work-sans">
      <div className="mb-8 font-work-sans">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 font-work-sans">
          <div className="font-work-sans">
            <h1 className="text-2xl font-bold mb-2 font-sora" style={{ color: 'var(--primary-color)' }}>
              Brand Lift Report
          </h1>
            <p className="text-sm font-work-sans" style={{ color: 'var(--secondary-color)' }}>
          ...
          <div className="flex mt-4 sm:mt-0 space-x-3 font-work-sans">
          <button
              onClick={handleExportVisualisation}
              className="px-4 py-2 bg-gray-100 rounded text-sm font-medium transition-colors hover:bg-gray-200 font-work-sans"
          ...
          <button
              ...
              className="px-4 py-2 rounded text-sm font-medium text-white transition-colors font-work-sans"
              style={{ backgroundColor: 'var(--accent-color)' }}
      ...
      <div className="space-y-8 font-work-sans">
        ...
        <section aria-labelledby="key-metrics-heading">
          <h2 id="key-metrics-heading" className="text-xl font-semibold mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>
        ...
        <section aria-labelledby="funnel-visualisation-heading">
          <h2 id="funnel-visualisation-heading" className="text-xl font-semibold mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>
            Funnel Performance
          </h2>
          <FunnelVisualisation />
        </section>
        ...
        <section aria-labelledby="demographic-breakdown-heading">
          <h2 id="demographic-breakdown-heading" className="text-xl font-semibold mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>
            Audience Insights
          </h2>
        ...
        <section aria-labelledby="survey-questions-heading">
          <h2 id="survey-questions-heading" className="text-xl font-semibold mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>
            Survey Details
          </h2>
          <SurveyQuestions />
        </section>
        ...
        <section aria-labelledby="time-chart-heading">
          <h2 id="time-chart-heading" className="text-xl font-semibold mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>
        ...
        <section aria-labelledby="word-cloud-heading">
          <h2 id="word-cloud-heading" className="text-xl font-semibold mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>
            Brand Associations
          </h2>
          <WordCloudSection />
        </section>
        ...
        <section aria-labelledby="recommendations-heading">
          <h2 id="recommendations-heading" className="text-xl font-semibold mb-4 font-sora" style={{ color: 'var(--primary-color)' }}>
            Actionable Insights
          </h2>
          <Recommendations />
        </section>
