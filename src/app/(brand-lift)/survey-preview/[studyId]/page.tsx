...
const SurveyPreviewSubmitPage: React.FC = () => {
            ...
            <ConditionalLayout>
                <div className="container mx-auto p-4 text-center">
                    <Alert variant="destructive">
                        ...
                        <AlertDescription>The Study ID is missing from the URL. Please go back and try again.</AlertDescription>
                    </Alert>
                </div>
            </ConditionalLayout>
        );
    ...
    const handleSubmitForReview = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                const errorData = await response.json().catch(() => ({ error: 'Failed to parse submission error' }));
        ...
        <ConditionalLayout>
            <div className="container mx-auto p-4 md:p-6">
                <div className="mb-6 flex flex-wrap justify-between items-center gap-4">
                    ...
                    <Button onClick={handleSubmitForReview} disabled={isSubmitting || submitSuccess} size="lg">
                        {isSubmitting ? <Icon iconId='faSpinnerLight' className='animate-spin mr-2 h-4 w-4' /> : <Icon iconId='faPaperPlaneLight' className='mr-2 h-4 w-4' />}
                ...
                {submitSuccess && (
                    <Alert variant="default" className="mb-4 bg-green-50 border-green-300 text-green-700 dark:bg-green-900 dark:text-green-200 dark:border-green-700">
                        ...
                        <AlertDescription>Survey submitted for review. Redirecting to approval page...</AlertDescription>
                    </Alert>
                )}
