    ...
    <div className="space-y-4">
      ...
      <div className="flex justify-end mt-6">
        <button
          ...
          className="ml-auto px-3 py-1.5 text-[var(--accent-color)] border border-[var(--accent-color)] 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="flex justify-between items-center py-3">
            ...
            <button
              onClick={() => onToggle('campaignUpdates', !preferences.campaignUpdates)}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300 focus:outline-none
                ${preferences.campaignUpdates ? 'bg-[var(--accent-color)]' : 'bg-gray-300'}`}
              role="switch"
              aria-checked={preferences.campaignUpdates}
            >
              <span
          ...
          <label className="flex items-center space-x-3 p-4 bg-[var(--background-color)] 
            ...
            <input
              ...
              className="form-checkbox h-5 w-5 text-[var(--accent-color)] rounded 
