...
export default function ClerkAuthDebugPage() {
    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-3xl font-bold text-primary mb-2">Clerk Authentication Debug</h1>
            <p className="text-muted-foreground">
              Debug and verify Clerk authentication configuration and user states.
            </p>
          </div>
          <Button variant="outline" asChild>
            <Link href="/debug-tools">← Back to Debug Tools</Link>
          </Button>
        </div>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-divider">
        ...
        <div className="flex flex-wrap gap-4">
          <Button variant="outline" asChild>
            <Link href="/sign-in">Test Sign In Flow</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/sign-up">Test Sign Up Flow</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/settings/profile">Test Profile Settings</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link href="/settings/team">Test Team Management</Link>
          </Button>
        </div>
      </div>
    </div>
