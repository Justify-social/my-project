        ...
        <CardContent>
            <div className="space-y-3">
                {executions.map((execution) => (
                    <div key={execution.id} className="flex items-center justify-between p-3 border border-divider rounded-lg">
                        <div className="flex-1">
                            <div className="font-medium">{execution.name}</div>
                            <div className="text-sm text-muted-foreground">{execution.spec}</div>
                        </div>
                        <div className="flex items-center gap-3">
                            <Badge variant={execution.status === 'passed' ? 'default' : execution.status === 'failed' ? 'destructive' : 'secondary'}>
                                {execution.status}
                            </Badge>
            ...
            <Card className="border-divider">
                ...
                <CardContent>
                    <div className="flex flex-wrap gap-2">
                        <Button variant="outline" size="sm">Export Test Report</Button>
                        <Button variant="outline" size="sm">Run All Tests</Button>
                        <Button variant="outline" size="sm">View Test Logs</Button>
                        <Button variant="outline" size="sm">Coverage Report</Button>
                        <Button variant="outline" size="sm">Performance Analysis</Button>
                    </div>
                </CardContent>
            </Card>
        </div>
