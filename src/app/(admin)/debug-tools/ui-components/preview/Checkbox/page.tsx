      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-divider rounded-lg p-6">
            <h3 className="text-lg font-medium mb-3">Basic with Label</h3>
          ...
          <div className="border border-divider rounded-lg p-6">
            <h3 className="text-lg font-medium mb-3">Checked State</h3>
            <div className="flex items-center space-x-2">
              <Checkbox id="checked-example" checked={true} />
              <Label htmlFor="checked-example">Already checked</Label>
            </div>
          </div>
          <div className="border border-divider rounded-lg p-6">
