...
export default function BarChartPreviewPage() {
  const componentMeta = {
    ...
    "description": "A responsive bar chart component using Recharts for comparing categorical data, supporting horizontal and vertical layouts.", // Updated description
    "category": "organism",
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData}
                  ...
                  <Bar dataKey="pv" fill="#3182CE" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="uv" fill="#4A5568" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} layout="vertical"
                  ...
                  />
                  <Legend wrapperStyle={{ fontSize: "12px" }} />
                  <Bar dataKey="pv" fill="#00BFFF" radius={[0, 4, 4, 0]} barSize={20} />
                  <Bar dataKey="uv" fill="#333333" radius={[0, 4, 4, 0]} barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
