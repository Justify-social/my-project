...
export default function ToasterPreviewPage() {
  ...
  const componentMeta = {
    "name": "Toaster",
    "description": "Renders toast notifications triggered by the `useToast` hook. Should be placed in the root layout.",
    "category": "organism",
        ...
        <div className="space-y-6">
          ...
          <div className="border border-divider rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              The `Toaster` component itself is placed in the application layout (e.g., `layout.tsx`).
              Below are examples of how to trigger toasts using the `useToast` hook, which the `Toaster` will then display.
            </p>
