...
export default function ToastPreviewPage() {
  ...
  const componentMeta = {
    name: 'Toast',
    description:
      'A succinct message that appears temporarily to provide feedback or updates. Requires Toaster component in layout.',
    category: 'molecule',
        ...
        <div className="space-y-6">
          ...
          <div className="border border-divider rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Note: The `Toaster` component must be added to your root layout for toasts to appear.
            </p>
