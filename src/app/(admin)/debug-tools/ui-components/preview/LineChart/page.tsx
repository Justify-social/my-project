...
export default function LineChartPreviewPage() {
  const componentMeta = {
    ...
    "description": "Responsive line chart component based on Recharts with support for multiple data series.", // Kept description
    "category": "organism",
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}
                  ...
                  <Line type="monotone" dataKey="pv" stroke="#3182CE" activeDot={{ r: 8 }} />
                  <Line type="monotone" dataKey="uv" stroke="#4A5568" />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData}
                  ...
                  <Line type="monotone" dataKey="amt" stroke="#00BFFF" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
