      ...
      <div className="mb-8">
        ...
        <div className="space-y-8"> {/* Increased spacing */}
          ...
          <div className="border border-divider rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground mb-3">SearchBar is a controlled component, requiring `value` and `onChange` props.</p>
            <SearchBar
              value={basicValue}
          ...
          <div className="border border-divider rounded-lg p-6">
            ...
            <div className="flex flex-col gap-4">
              <SearchBar value="" onChange={() => { }} placeholder="Small (sm)" size="sm" className="max-w-sm" />
              <SearchBar value="" onChange={() => { }} placeholder="Medium (md - default)" size="md" className="max-w-sm" />
              <SearchBar value="" onChange={() => { }} placeholder="Large (lg)" size="lg" className="max-w-sm" />
            </div>
          </div>
          ...
          <div className="border border-divider rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground mb-3">Automatically triggers `onSearch` after a debounce period (500ms here). Check console.</p>
