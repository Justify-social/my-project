      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-divider rounded-lg p-6">
            ...
            {/* Replace with actual Resizable component rendering using imported parts */}
            {/* 
            ...
            */}
            <p className="text-sm text-muted-foreground">(Manually add rendering example for Resizable components here)</p>
          </div>
