...
const scatterData02 = [
  ...
  { x: 190, y: 290, z: 500 }, { x: 198, y: 250, z: 400 },
  { x: 180, y: 280, z: 280 }, { x: 210, y: 220, z: 200 },
];
...
export default function ScatterChartPreviewPage() {
  const componentMeta = {
    ...
    "description": "A responsive scatter chart component using Recharts for visualizing correlations and distributions.",
    "category": "organism",
    "subcategory": "chart",
    "renderType": "client",
    "status": "stable",
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-divider rounded-lg p-6">
            <h3 className="text-lg font-medium mb-3">Basic Scatter Chart (Two Series)</h3>
          ...
          <div className="border border-divider rounded-lg p-6">
            <h3 className="text-lg font-medium mb-3">Bubble Chart (Size based on Z value)</h3>
            <div className="h-[350px]">
              <ResponsiveContainer width="100%" height="100%">
                <ScatterChart
                  margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                  ...
                  />
                  <Legend wrapperStyle={{ fontSize: "12px", paddingTop: "10px" }} />
                  <Scatter name="A school" data={scatterData01} fill="hsl(var(--primary))" fillOpacity={0.7} />
                  <Scatter name="B school" data={scatterData02} fill="hsl(var(--secondary))" fillOpacity={0.7} />
                </ScatterChart>
              </ResponsiveContainer>
            </div>
          </div>
