...
const HelpPage: React.FC = () => {
  ...
  const glossaryTerms: GlossaryTerm[] = [{
    ...
    examples: ["25% increase in brand awareness among users exposed to influencer content", "12% lift in purchase consideration after TikTok campaign"]
  }, {
    ...
    examples: ["Testing different visual styles across influencer partnerships", "Analyzing which call-to-action generates highest engagement"]
  }, {
    ...
    examples: ["Determining that influencer marketing drives 35% more conversions than paid social", "Identifying optimal spending ratio between different campaign types"]
  }, {
    ...
    examples: ["Flagging creators with significant fake followers before campaign launch", "Identifying potential controversial content in creator's history"]
  }];
