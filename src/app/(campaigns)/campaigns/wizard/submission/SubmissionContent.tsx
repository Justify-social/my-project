...
import ErrorBoundary from '@/components/features/core/error-handling/ErrorBoundary';
...
function SubmissionContent() {
  ...
  if (error) {
    return (
      <div className="w-full max-w-7xl mx-auto px-4 py-8 min-h-screen font-body">
        <div className="bg-[var(--background-color)] p-6 rounded-lg border border-[var(--divider-color)] font-body">
          <h3 className="text-[var(--primary-color)] font-medium text-lg font-heading">Error Loading Campaign</h3>
          <p className="text-[var(--secondary-color)] mt-2 font-body">{error}</p>
          <button
            onClick={() => router.push('/campaigns')}
            className="mt-4 px-4 py-2 bg-[var(--primary-color)] text-[var(--background-color)] rounded-md hover:bg-[var(--interactive-color)] flex items-center font-body"
          >
  ...
  if (!campaign) {
    return (
      <div className="w-full max-w-7xl mx-auto px-4 py-8 min-h-screen font-body">
        <div className="bg-[var(--background-color)] p-6 rounded-lg border border-[var(--divider-color)] font-body">
          <h3 className="text-[var(--primary-color)] font-medium text-lg font-heading">Campaign Data Missing</h3>
          <p className="text-[var(--secondary-color)] mt-2 font-body">
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 bg-white min-h-screen font-body">
      ...
      <div className="bg-[var(--background-color)] rounded-xl border border-[var(--divider-color)] p-8 shadow-sm mb-12 text-center font-body">
        <div className="mx-auto w-20 h-20 bg-[var(--accent-color)]/20 rounded-full flex items-center justify-center mb-6 font-body">
          <Icon iconId="faCheckLight" className="h-12 w-12 text-[var(--accent-color)] font-body" />
        </div>

        <h2 className="text-2xl font-bold text-[var(--primary-color)] mb-3 font-heading">
          Campaign successfully submitted!
        </h2>

        {/* Add campaign status badge */}
        <div className="flex justify-center items-center mb-6 font-body">
          <div className="flex items-center bg-[var(--background-color)] text-[var(--primary-color)] px-4 py-2 rounded-full text-sm font-medium line-through mr-2 font-body">
            DRAFT
          </div>
          <div className="text-[var(--secondary-color)] mx-2 font-body">→</div>
          <div className="flex items-center bg-[var(--background-color)] text-[var(--primary-color)] px-4 py-2 rounded-full text-sm font-medium font-body">
            APPROVED
          </div>
        </div>
      ...
      <div className="mb-12 font-body">
        <h3 className="text-xl font-semibold text-[var(--primary-color)] mb-6 font-heading">
          Next Steps:
        </h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-body">
          {/* Set Up Brand Lift Study */}
          <div className="bg-[var(--background-color)] rounded-xl p-6 shadow-sm border border-[var(--divider-color)] flex flex-col h-full font-body">
            <div className="flex-1 font-body">
              <h3 className="font-semibold text-[var(--primary-color)] text-lg mb-2 font-heading">
                Set Up Brand Lift Study
              </h3>
            ...
            <Link
              href="/brand-lift"
              className="flex items-center justify-end text-[var(--accent-color)] hover:text-[var(--interactive-color)] mt-2 text-sm font-medium font-body"
            >
      ...
      <div className="flex justify-between items-center font-body">
        <button
          onClick={() => router.push('/campaigns')}
          className="flex items-center text-[var(--secondary-color)] hover:text-[var(--primary-color)] font-medium font-body"
        >
          <Icon iconId="faChevronLeftLight" className="w-4 h-4 mr-2" />
          Back to Campaigns
        </button>
        ...
        <button
          ...
          className="flex items-center bg-[var(--accent-color)] text-[var(--background-color)] px-5 py-2 rounded-md hover:bg-[var(--interactive-color)] font-['Work Sans'] font-body"
        >
