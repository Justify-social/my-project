// This file is deprecated and has been replaced by src/middleware.ts
// The middleware now uses a more targeted authentication approach without withMiddlewareAuthRequired
// for better navigation component rendering

// Keeping this file as reference but it should no longer be used
// See src/middleware.ts for the current implementation

// For historical reference only:
// Previously used withMiddlewareAuthRequired which caused rendering issues
// Now using more selective auth checks for specific routes only
