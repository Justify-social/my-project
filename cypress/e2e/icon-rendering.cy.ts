describe('Icon Rendering', () => {
  ...
  it('should render light icons correctly', () => {
    ...
    cy.get('[data-testid="light-icon-demo"] img')
      .first()
  ...
  it('should render solid icons correctly', () => {
    ...
    cy.get('[data-testid="solid-icon-demo"] img')
      .first()
      .should('have.attr', 'src')
  ...
  it('should render brand icons correctly', () => {
    ...
    cy.get('[data-testid="brand-icon-demo"] img')
      .first()
      .should('have.attr', 'src')
  ...
  it('should render different icon sizes correctly', () => {
    // Check small icon
    cy.get('[data-testid="size-sm-icon"]')
      .should('be.visible')
      .and('have.class', 'w-4')
      .and('have.class', 'h-4');

    // Check medium icon
    cy.get('[data-testid="size-md-icon"]')
      .should('be.visible')
      .and('have.class', 'w-5')
      .and('have.class', 'h-5');

    // Check large icon
    cy.get('[data-testid="size-lg-icon"]')
      .should('be.visible')
      .and('have.class', 'w-6')
      .and('have.class', 'h-6');

    // Check extra large icon
    cy.get('[data-testid="size-xl-icon"]')
      .should('be.visible')
      .and('have.class', 'w-8')
      .and('have.class', 'h-8');
  });
