# Phyllo API Integration Reference for Justify.social
...
*   **API Name:** `Content Demographics API` (Marked as Coming Soon by Phyllo)
...
*   **API Name:** `Comment Analysis and Purchase Intent API` (Premium)
