    ...
    return [
      {
        ...
        headers: [
          // Content Security Policy (CSP)
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://vercel.live https://*.clerk.accounts.dev https://*.clerk.dev https://*.clerk.com https://clerk.com https://challenges.cloudflare.com https://www.gstatic.com https://js.clerk.com https://js.clerk.dev",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.clerk.dev https://*.clerk.com",
              "img-src 'self' data: blob: https: http:",
              "font-src 'self' https://fonts.gstatic.com",
              "connect-src 'self' https://api.clerk.dev https://*.clerk.accounts.dev https://clerk.dev https://*.clerk.dev https://*.clerk.com https://clerk.com https://api.clerk.com https://*.vercel.live https://vercel.live wss://*.pusher.com wss://ws.pusher.com https://vitals.vercel-insights.com https://api.insightiq.ai https://api.mux.com https://api.ipgeolocation.io https://api.giphy.com https://inferred.litix.io https://clerk-telemetry.com https://stream.mux.com https://api.sandbox.insightiq.ai",
