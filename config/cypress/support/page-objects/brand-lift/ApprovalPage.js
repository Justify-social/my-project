...
export class ApprovalPage extends BasePage {
    ...
    elements = {
        ...
        questionOptions: (index) => this.elements.questionItem(index).find('[data-cy="question-options"]'),
        ...
        commentTimestamp: (index) => this.elements.commentItem(index).find('[data-cy="comment-timestamp"]'),
