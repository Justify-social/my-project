...
export class BrandLiftPage extends BasePage {
    ...
    elements = {
        ...
        // Study actions
        viewStudyButton: (studyName) => this.elements.studyActionsCell(studyName).find('button').contains('View'),
        editStudyButton: (studyName) => this.elements.studyActionsCell(studyName).find('button').contains('Edit'),
        duplicateStudyButton: (studyName) => this.elements.studyActionsCell(studyName).find('button').contains('Duplicate'),
        deleteStudyButton: (studyName) => this.elements.studyActionsCell(studyName).find('button').contains('Delete'),
        ...
        duplicateConfirmButton: () => this.elements.duplicateModal().find('button').contains('Duplicate'),
    ...
    validateStudyStatuses() {
        ...
        statuses.forEach(status => {
            cy.get('tbody tr').each($row => {
                cy.wrap($row).within(() => {
                    cy.get('td').eq(2).then($statusCell => {
