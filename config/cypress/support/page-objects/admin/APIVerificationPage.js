...
export class APIVerificationPage extends BasePage {
    ...
    setRequestHeaders(headers) {
        ...
        this.elements.requestHeaders().clear().type(JSON.stringify(headers, null, 2));
        return this;
    }

    setRequestBody(body) {
        this.logAction('Setting request body');
        this.elements.requestBody().clear().type(typeof body === 'string' ? body : JSON.stringify(body, null, 2));
        return this;
    }
    ...
    expectResponseTime(maxTime) {
        this.elements.responseTime().invoke('text').then(text => {
    ...
    expectOverallHealthScore(minScore) {
        this.elements.overallHealthScore().invoke('text').then(text => {
    ...
    expectSuccessRate(minRate) {
        this.elements.successRate().invoke('text').then(text => {
    ...
    expectBatchTestCount(expectedCount) {
        this.elements.batchTestList().find('[data-testid^="batch-test-"]').should('have.length', expectedCount);
        return this;
    }
