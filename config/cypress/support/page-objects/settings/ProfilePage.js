...
export class ProfilePage extends BasePage {
  ...
  elements = {
    ...
    setPrimaryEmailButton: email =>
      cy.contains(email).parent().find('button').contains('Set as primary'),
    ...
    setPrimaryPhoneButton: phone =>
      cy.contains(phone).parent().find('button').contains('Set as primary'),
