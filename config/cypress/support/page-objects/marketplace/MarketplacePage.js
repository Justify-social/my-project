...
export class MarketplacePage extends BasePage {
    ...
    elements = {
        ...
        influencerCardByHandle: (handle) => cy.get(`[data-testid="influencer-card"][data-handle="${handle}"]`),

        // Influencer card elements
        influencerAvatar: (handle) => this.elements.influencerCardByHandle(handle).find('[data-testid="avatar"]'),
        influencerName: (handle) => this.elements.influencerCardByHandle(handle).find('[data-testid="name"]'),
        influencerHandle: (handle) => this.elements.influencerCardByHandle(handle).find('[data-testid="handle"]'),
        influencerPlatform: (handle) => this.elements.influencerCardByHandle(handle).find('[data-testid="platform"]'),
        influencerFollowers: (handle) => this.elements.influencerCardByHandle(handle).find('[data-testid="followers"]'),
        influencerEngagement: (handle) => this.elements.influencerCardByHandle(handle).find('[data-testid="engagement"]'),
        influencerVerified: (handle) => this.elements.influencerCardByHandle(handle).find('[data-testid="verified"]'),

        // Selection functionality
        selectCheckbox: (handle) => this.elements.influencerCardByHandle(handle).find('input[type="checkbox"]'),
        selectAllCheckbox: () => cy.get('input[data-testid="select-all"]'),
        selectedCount: () => cy.get('[data-testid="selected-count"]'),

        // Action buttons on cards
        viewProfileButton: (handle) => this.elements.influencerCardByHandle(handle).find('button').contains('View Profile'),
        addToCampaignButton: (handle) => this.elements.influencerCardByHandle(handle).find('button').contains('Add to Campaign'),
    ...
    expectInfluencerCount(expectedCount) {
        this.elements.influencerList().find('[data-testid^="influencer-card"]').should('have.length', expectedCount);
        return this;
    }
