...
export class InfluencerEngagementPage extends BasePage {
  ...
  testCampaignIntegration() {
    ...
    this.performCompleteEngagementWorkflow('Test Influencer', 'Test Campaign', {
      type: 'sponsored-post',
  ...
  testCompleteEngagementWorkflow() {
    ...
    this.performCompleteEngagementWorkflow('Fashion Influencer', 'Summer Collection Campaign', {
      type: 'sponsored-post',
