...
import { UIComponentsPage } from '../../support/page-objects';
...
describe('UI Components - Button Component Testing', () => {
  ...
  context('Button Component - Basic Functionality', () => {
    ...
    it('should test interactive button behavior', () => {
      ...
      cy.get('button:not([disabled]):visible:not([data-cy="mobile-menu-button"])')
        .first()
        .as('testButton');
      ...
      cy.get('button:visible').first().focus().trigger('keydown', { key: 'Tab' });
