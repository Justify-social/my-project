describe('Campaign Wizard - Step 4: Creative Assets', () => {
      ...
      body: {
        ...
        assets: [
          ...
          },
          {
            ...
            thumbnail: '/assets/banner-2-thumb.jpg',
          },
        ],
      },
    }).as('uploadAssets');
  ...
  it('adds and edits descriptions', () => {
    // Type a description
    cy.get('[data-cy="description-1"]').type(
    ...
    cy.get('[data-cy="description-2"]').type(
      'Sale ends this Sunday. Visit our website or local store to view all discounted items.'
    );
