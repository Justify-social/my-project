...
try {
  ...
  if (!fs.existsSync(reportPath)) {
    ...
    execSync('node scripts/audit-icons.js', { stdio: 'inherit' });
  }
...
console.log(`${colors.cyan}1. Run 'node scripts/audit-icons.js' to check for remaining issues${colors.reset}`);
