/**
 * This script fixes incorrect icon style issues by ensuring:
 * 1. Light icons are truly light versions (not duplicate solid icons)
 * 2. Icon files correspond to the correct semantic names in our mapping
 * 
 * Usage:
 *   node scripts/fix-icon-svgs.js
 */
