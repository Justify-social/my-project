...
console.log(`Scan complete. Found ${stats.totalIssuesFound} potential hook issues and encountered ${stats.totalErrorsEncountered} errors.`);
...
try {
    ...
    console.error(`Failed to write report file at ${path.relative(PROJECT_ROOT, REPORT_FILE)}:`, error);
