...
export type IconName = 'faXmark' | 'faVideo' | 'faUsers' | 'faUser' | 'faUserGroup' | 'faUpload' | 'faUnlock' | 'faTrophy' | 'faTriangleExclamation' | 'faTrash' | 'faTrashCan' | 'faThumbsUp' | 'faTag' | 'faTable' | 'faTableCells' | 'faStar' | 'faSpinner' | 'faSignal' | 'faShield' | 'faShare' | 'faServer' | 'faRotate' | 'faRotateRight' | 'faRocket' | 'faRightToBracket' | 'faRightFromBracket' | 'faQuestion' | 'faPrint' | 'faPresentationScreen' | 'faPlus' | 'faPlay' | 'faPhone' | 'faPencil' | 'faPen' | 'faPenToSquare' | 'faPause' | 'faPaperclip' | 'faPaperPlane' | 'faPalette' | 'faMoneyBill' | 'faMinus' | 'faMegaphone' | 'faMap' | 'faMagnifyingGlass' | 'faMagnifyingGlassPlus' | 'faLock' | 'faList' | 'faLightbulb' | 'faKey' | 'faInfo' | 'faImage' | 'faHouse' | 'faHeart' | 'faGlobe' | 'faGear' | 'faForward' | 'faFloppyDisk' | 'faFlag' | 'faFlagCheckered' | 'faFilter' | 'faFile' | 'faFileVideo' | 'faFileLines' | 'faFileImage' | 'faFileAudio' | 'faEye' | 'faEyeSlash' | 'faExclamation' | 'faEnvelope' | 'faDownload' | 'faDollarSign' | 'faCreditCard' | 'faCopy' | 'faComments' | 'faComment' | 'faCommentDots' | 'faClock' | 'faClockRotateLeft' | 'faCircle' | 'faCircleXmark' | 'faCircleUser' | 'faCircleQuestion' | 'faCircleNotch' | 'faCircleInfo' | 'faCircleCheck' | 'faChevronUp' | 'faChevronRight' | 'faChevronLeft' | 'faChevronDown' | 'faCheck' | 'faChartPie' | 'faChartLine' | 'faChartColumn' | 'faChartBar' | 'faCamera' | 'faCalendar' | 'faCalendarDays' | 'faBurger' | 'faBullseye' | 'faBuilding' | 'faBug' | 'faBookmark' | 'faBolt' | 'faBell' | 'faBellSlash' | 'faBars' | 'faArrowUp' | 'faArrowTrendUp' | 'faArrowTrendDown' | 'faArrowRight' | 'faArrowLeft' | 'faArrowDown' | 'faYoutube' | 'faXTwitter' | 'faTwitter' | 'faTiktok' | 'faReddit' | 'faPinterest' | 'faLinkedin' | 'faInstagram' | 'faGithub' | 'faFacebook' | 'faPauseLight' | 'faChevronLeftLight' | 'faPenToSquareLight' | 'faChevronUpLight' | 'faCircleInfoLight' | 'faTrophyLight' | 'faPlayLight' | 'faUserGroupLight' | 'faSignalLight' | 'faShieldLight' | 'faHouseLight' | 'faTrashLight' | 'faVideoLight' | 'faRightToBracketLight' | 'faTagLight' | 'faRotateLight' | 'faSpinnerLight' | 'faSearchLight' | 'faTrashCanLight' | 'faPrintLight' | 'faBellLight' | 'faEnvelopeLight' | 'faRotateRightLight' | 'faUsersLight' | 'faCalendarLight' | 'faCircleXmarkLight' | 'faPresentationScreenLight' | 'faServerLight' | 'faUserLight' | 'faRocketLight' | 'faXmarkLight' | 'faMinusLight' | 'faTriangleExclamationLight' | 'faUploadLight' | 'faPlusLight' | 'faTableLight' | 'faRightFromBracketLight' | 'faCheckLight' | 'faChevronDownLight' | 'faCircleCheckLight' | 'faShareLight' | 'faThumbsUpLight' | 'faPencilLight' | 'faStarLight' | 'faMagnifyingGlassPlusLight' | 'faQuestionLight' | 'faPaletteLight' | 'faPhoneLight' | 'faChevronRightLight' | 'faLightbulbLight' | 'faUnlockLight' | 'faTableCellsLight' | 'faPaperPlaneLight' | 'faMagnifyingGlassLight' | 'faGlobeLight' | 'faInfoLight' | 'faPenLight' | 'faMegaphoneLight' | 'faFlagLight' | 'faEyeSlashLight' | 'faFileLinesLight' | 'faPaperclipLight' | 'faMapLight' | 'faMoneyBillLight' | 'faForwardLight' | 'faGearLight' | 'faKeyLight' | 'faListLight' | 'faImageLight' | 'faFlagCheckeredLight' | 'faCommentDotsLight' | 'faDollarSignLight' | 'faFileLight' | 'faCommentLight' | 'faCreditCardLight' | 'faHeartLight' | 'faBugLight' | 'faFileVideoLight' | 'faBookmarkLight' | 'faDownloadLight' | 'faFileImageLight' | 'faExclamationLight' | 'faFilterLight' | 'faCircleNotchLight' | 'faBoltLight' | 'faFileAudioLight' | 'faClockRotateLeftLight' | 'faEyeLight' | 'faCameraLight' | 'faChartLineLight' | 'faCommentsLight' | 'faCircleLight' | 'faChartColumnLight' | 'faBellSlashLight' | 'faFloppyDiskLight' | 'faLockLight' | 'faArrowUpLight' | 'faCircleQuestionLight' | 'faChartBarLight' | 'faCopyLight' | 'faChartPieLight' | 'faBarsLight' | 'faClockLight' | 'faArrowLeftLight' | 'faArrowTrendDownLight' | 'faBurgerLight' | 'faBuildingLight' | 'faCalendarDaysLight' | 'faCircleUserLight' | 'faArrowTrendUpLight' | 'faArrowRightLight' | 'faArrowDownLight' | 'faBullseyeLight';
...
export const iconData: Record<IconName, IconData> = {
  ...
  "faSpinner": {
    ...
    "url": "/ui-icons/solid/spinner.svg"
  },
  "faSignal": {
    "width": 640,
    "height": 512,
  ...
  "faRotateRight": {
    ...
    "url": "/ui-icons/solid/rotate-right.svg"
  },
  "faRocket": {
    "width": 512,
    "height": 512,
  ...
  "faFileVideo": {
    ...
    "url": "/ui-icons/solid/file-video.svg"
  },
  "faFileLines": {
    "width": 384,
    "height": 512,
  ...
  "faFileImage": {
    ...
    "url": "/ui-icons/solid/file-image.svg"
  },
  "faFileAudio": {
    "width": 384,
    "height": 512,
    ...
    "url": "/ui-icons/solid/file-audio.svg"
  },
  "faEye": {
    "width": 576,
    "height": 512,
  ...
  "faYoutube": {
    ...
    "url": "/ui-icons/brands/youtube.svg"
  },
  "faXTwitter": {
    "width": 512,
    "height": 512,
    "path": "M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z",
    "url": "/ui-icons/brands/x-twitter.svg"
  },
  "faTwitter": {
    "width": 512,
    "height": 512,
    ...
    "url": "/ui-icons/brands/twitter.svg"
  },
  "faTiktok": {
    "width": 448,
    "height": 512,
    ...
    "url": "/ui-icons/brands/tiktok.svg"
  },
  "faReddit": {
    "width": 512,
    "height": 512,
    ...
    "url": "/ui-icons/brands/reddit.svg"
  },
  "faPinterest": {
    "width": 496,
    "height": 512,
  ...
  "faInstagram": {
    ...
    "url": "/ui-icons/brands/instagram.svg"
  },
  "faGithub": {
    "width": 496,
    "height": 512,
    ...
    "url": "/ui-icons/brands/github.svg"
  },
  "faFacebook": {
    "width": 512,
    "height": 512,
    ...
    "url": "/ui-icons/brands/facebook.svg"
  },
  "faPauseLight": {
    "width": 320,
    "height": 512,
  ...
  "faTrashLight": {
    "width": 448,
    "height": 512,
    "path": "M177.7 32l92.5 0c5.5 0 10.6 2.8 13.6 7.5L299.1 64 148.9 64l15.3-24.5c2.9-4.7 8.1-7.5 13.6-7.5zM336.9 64L311 22.6C302.2 8.5 286.8 0 270.3 0L177.7 0C161.2 0 145.8 8.5 137 22.6L111.1 64 64.1 64 32 64 16 64C7.2 64 0 71.2 0 80s7.2 16 16 16l18.3 0L59.8 452.6C62.1 486.1 90 512 123.6 512l200.8 0c33.6 0 61.4-25.9 63.8-59.4L413.7 96 432 96c8.8 0 16-7.2 16-16s-7.2-16-16-16l-16 0-32.1 0-47.1 0zm44.8 32L356.3 450.3C355.1 467 341.2 480 324.4 480l-200.8 0c-16.8 0-30.7-13-31.9-29.7L66.4 96l315.3 0z",
    "url": "/ui-icons/light/trash.svg"
  },
  "faVideoLight": {
    "width": 576,
    "height": 512,
    "path": "M64 96c-17.7 0-32 14.3-32 32l0 256c0 17.7 14.3 32 32 32l256 0c17.7 0 32-14.3 32-32l0-256c0-17.7-14.3-32-32-32L64 96zM0 128C0 92.7 28.7 64 64 64l256 0c35.3 0 64 28.7 64 64l0 47.2 0 161.6 0 47.2c0 35.3-28.7 64-64 64L64 448c-35.3 0-64-28.7-64-64L0 128zM519.4 411.3L416 354.4l0-36.5 118.8 65.4c.9 .5 1.9 .8 3 .8c3.4 0 6.2-2.8 6.2-6.2l0-243.6c0-3.4-2.8-6.2-6.2-6.2c-1 0-2.1 .3-3 .8L416 194.1l0-36.5 103.4-56.9c5.6-3.1 12-4.7 18.4-4.7c21.1 0 38.2 17.1 38.2 38.2l0 243.6c0 21.1-17.1 38.2-38.2 38.2c-6.4 0-12.8-1.6-18.4-4.7z",
  ...
  "faPencilLight": {
    "width": 512,
    "height": 512,
    "path": "M395.8 39.6c9.4-9.4 24.6-9.4 33.9 0l42.6 42.6c9.4 9.4 9.4 24.6 0 33.9L417.6 171 341 94.4l54.8-54.8zM318.4 117L395 193.6l-219 219 0-12.6c0-8.8-7.2-16-16-16l-32 0 0-32c0-8.8-7.2-16-16-16l-12.6 0 219-219zM66.9 379.5c1.2-4 2.7-7.9 4.7-11.5L96 368l0 32c0 8.8 7.2 16 16 16l32 0 0 24.4c-3.7 1.9-7.5 3.5-11.6 4.7L39.6 472.4l27.3-92.8zM452.4 17c-21.9-21.9-57.3-21.9-79.2 0L60.4 329.7c-11.4 11.4-19.7 25.4-24.2 40.8L.7 491.5c-1.7 5.6-.1 11.7 4 15.8s10.2 5.7 15.8 4l121-35.6c15.4-4.5 29.4-12.9 40.8-24.2L495 138.8c21.9-21.9 21.9-57.3 0-79.2L452.4 17zM331.3 202.7c6.2-6.2 6.2-16.4 0-22.6s-16.4-6.2-22.6 0l-128 128c-6.2 6.2-6.2 16.4 0 22.6s16.4 6.2 22.6 0l128-128z",
  ...
  "faMagnifyingGlassPlusLight": {
    "width": 512,
    "height": 512,
    "path": "M208 32a176 176 0 1 1 0 352 176 176 0 1 1 0-352zm0 384c51.7 0 99-18.8 135.3-50L484.7 507.3c6.2 6.2 16.4 6.2 22.6 0s6.2-16.4 0-22.6L366 343.3c31.2-36.4 50-83.7 50-135.3C416 93.1 322.9 0 208 0S0 93.1 0 208S93.1 416 208 416zM192 304c0 8.8 7.2 16 16 16s16-7.2 16-16l0-80 80 0c8.8 0 16-7.2 16-16s-7.2-16-16-16l-80 0 0-80c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 80-80 0c-8.8 0-16 7.2-16 16s7.2 16 16 16l80 0 0 80z",
  ...
  "faGlobeLight": {
    "width": 512,
    "height": 512,
    "path": "M256 480c16.7 0 40.4-14.4 61.9-57.3c9.9-19.8 18.2-43.7 24.1-70.7l-172 0c5.9 27 14.2 50.9 24.1 70.7C215.6 465.6 239.3 480 256 480zM164.3 320l183.4 0c2.8-20.2 4.3-41.7 4.3-64s-1.5-43.8-4.3-64l-183.4 0c-2.8 20.2-4.3 41.7-4.3 64s1.5 43.8 4.3 64zM170 160l172 0c-5.9-27-14.2-50.9-24.1-70.7C296.4 46.4 272.7 32 256 32s-40.4 14.4-61.9 57.3C184.2 109.1 175.9 133 170 160zm210 32c2.6 20.5 4 41.9 4 64s-1.4 43.5-4 64l90.8 0c6-20.3 9.3-41.8 9.3-64s-3.2-43.7-9.3-64L380 192zm78.5-32c-25.9-54.5-73.1-96.9-130.9-116.3c21 28.3 37.6 68.8 47.2 116.3l83.8 0zm-321.1 0c9.6-47.6 26.2-88 47.2-116.3C126.7 63.1 79.4 105.5 53.6 160l83.7 0zm-96 32c-6 20.3-9.3 41.8-9.3 64s3.2 43.7 9.3 64l90.8 0c-2.6-20.5-4-41.9-4-64s1.4-43.5 4-64l-90.8 0zM327.5 468.3c57.8-19.5 105-61.8 130.9-116.3l-83.8 0c-9.6 47.6-26.2 88-47.2 116.3zm-143 0c-21-28.3-37.5-68.8-47.2-116.3l-83.7 0c25.9 54.5 73.1 96.9 130.9 116.3zM256 512A256 256 0 1 1 256 0a256 256 0 1 1 0 512z",
    "url": "/ui-icons/light/globe.svg"
  },
  "faInfoLight": {
    "width": 192,
    "height": 512,
    "path": "M64 64a32 32 0 1 1 64 0A32 32 0 1 1 64 64zM16 176c0-8.8 7.2-16 16-16l64 0c8.8 0 16 7.2 16 16l0 272 64 0c8.8 0 16 7.2 16 16s-7.2 16-16 16L16 480c-8.8 0-16-7.2-16-16s7.2-16 16-16l64 0 0-256-48 0c-8.8 0-16-7.2-16-16z",
  ...
  "faMapLight": {
    "width": 576,
    "height": 512,
    "path": "M170.1 33.1c3.3-1.3 6.9-1.5 10.3-.5L399.1 95.1l144-57.6c15.8-6.3 32.9 5.3 32.9 22.3l0 334.8c0 9.8-6 18.6-15.1 22.3l-155 62c-3.3 1.3-6.9 1.5-10.3 .5L176.9 416.9l-144 57.6C17.1 480.8 0 469.2 0 452.2L0 117.4c0-9.8 6-18.6 15.1-22.3l155-62zM32 122.8l0 317.5 128-51.2 0-317.5L32 122.8zm352 320l0-318.7L192 69.2l0 318.7 192 54.9zm32-2.4l128-51.2 0-317.5L416 122.8l0 317.5z",
  ...
  "faCreditCardLight": {
    "width": 576,
    "height": 512,
    "path": "M64 64C46.3 64 32 78.3 32 96l0 32 512 0 0-32c0-17.7-14.3-32-32-32L64 64zM32 160l0 64 512 0 0-64L32 160zm0 96l0 160c0 17.7 14.3 32 32 32l448 0c17.7 0 32-14.3 32-32l0-160L32 256zM0 96C0 60.7 28.7 32 64 32l448 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L64 480c-35.3 0-64-28.7-64-64L0 96zM96 368c0-8.8 7.2-16 16-16l64 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-64 0c-8.8 0-16-7.2-16-16zm128 0c0-8.8 7.2-16 16-16l128 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-128 0c-8.8 0-16-7.2-16-16z",
  ...
  "faCameraLight": {
    "width": 512,
    "height": 512,
    "path": "M191.1 32c-20.7 0-39 13.2-45.5 32.8L135.1 96 64 96C28.7 96 0 124.7 0 160L0 416c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-256c0-35.3-28.7-64-64-64l-71.1 0L366.5 64.8C359.9 45.2 341.6 32 320.9 32L191.1 32zM175.9 74.9c2.2-6.5 8.3-10.9 15.2-10.9l129.9 0c6.9 0 13 4.4 15.2 10.9l14 42.1c2.2 6.5 8.3 10.9 15.2 10.9l82.7 0c17.7 0 32 14.3 32 32l0 256c0 17.7-14.3 32-32 32L64 448c-17.7 0-32-14.3-32-32l0-256c0-17.7 14.3-32 32-32l82.7 0c6.9 0 13-4.4 15.2-10.9l14-42.1zM256 400a112 112 0 1 0 0-224 112 112 0 1 0 0 224zM176 288a80 80 0 1 1 160 0 80 80 0 1 1 -160 0z",
  ...
  "faCommentsLight": {
    "width": 640,
    "height": 512,
    "path": "M32 176c0-74.8 73.7-144 176-144s176 69.2 176 144s-73.7 144-176 144c-15.3 0-30.6-1.9-46.3-5c-3.5-.7-7.1-.2-10.2 1.4c-6.1 3.1-12 6-18 8.7c-28.4 12.9-60.2 23.1-91.5 26c14.9-19 26.8-39.7 37.6-59.9c3.3-6.1 2.3-13.6-2.5-18.6C50 244.2 32 213.1 32 176zM208 0C93.1 0 0 78.9 0 176c0 44.2 19.8 80.1 46 110c-11.7 21-24 40.6-39.5 57.5c0 0 0 0 0 0l-.1 .1c-6.5 7-8.2 17.1-4.4 25.8C5.8 378.3 14.4 384 24 384c43 0 86.5-13.3 122.7-29.7c4.9-2.2 9.6-4.5 14.3-6.8c15.3 2.8 30.9 4.6 47 4.6c114.9 0 208-78.9 208-176S322.9 0 208 0zM447.4 160.5C541.6 167 608 233 608 304c0 37.1-18 68.2-45.1 96.6c-4.8 5-5.8 12.5-2.5 18.6c10.9 20.2 22.7 40.8 37.6 59.9c-31.3-3-63.2-13.2-91.5-26c-6-2.7-11.9-5.6-18-8.7c-3.2-1.6-6.8-2.1-10.2-1.4c-15.6 3.1-30.9 5-46.3 5c-68.2 0-123.6-30.7-153.1-73.3c-11 3-22.3 5.2-33.8 6.8C279 439.8 349.9 480 432 480c16.1 0 31.7-1.8 47-4.6c4.6 2.3 9.4 4.6 14.3 6.8C529.5 498.7 573 512 616 512c9.6 0 18.2-5.7 22-14.5c3.8-8.7 2-18.9-4.4-25.8l-.1-.1s0 0 0 0c-15.5-17-27.8-36.5-39.5-57.5c26.2-29.9 46-65.8 46-110c0-94.4-87.8-171.5-198.2-175.8c2.8 10.4 4.7 21.2 5.6 32.3z",
  ...
  "faLockLight": {
    "width": 448,
    "height": 512,
    "path": "M128 128l0 64 192 0 0-64c0-53-43-96-96-96s-96 43-96 96zM96 192l0-64C96 57.3 153.3 0 224 0s128 57.3 128 128l0 64 16 0c44.2 0 80 35.8 80 80l0 160c0 44.2-35.8 80-80 80L80 512c-44.2 0-80-35.8-80-80L0 272c0-44.2 35.8-80 80-80l16 0zM32 272l0 160c0 26.5 21.5 48 48 48l288 0c26.5 0 48-21.5 48-48l0-160c0-26.5-21.5-48-48-48L80 224c-26.5 0-48 21.5-48 48z",
    "url": "/ui-icons/light/lock.svg"
  },
  "faArrowUpLight": {
    "width": 384,
    "height": 512,
    "path": "M203.3 36.7c-6.2-6.2-16.4-6.2-22.6 0l-176 176c-6.2 6.2-6.2 16.4 0 22.6s16.4 6.2 22.6 0L176 86.6 176 464c0 8.8 7.2 16 16 16s16-7.2 16-16l0-377.4L356.7 235.3c6.2 6.2 16.4 6.2 22.6 0s6.2-16.4 0-22.6l-176-176z",
  ...
  "faClockLight": {
    "width": 512,
    "height": 512,
    "path": "M480 256A224 224 0 1 1 32 256a224 224 0 1 1 448 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM240 112l0 144c0 5.3 2.7 10.3 7.1 13.3l96 64c7.4 4.9 17.3 2.9 22.2-4.4s2.9-17.3-4.4-22.2L272 247.4 272 112c0-8.8-7.2-16-16-16s-16 7.2-16 16z",
  ...
  "faArrowTrendDownLight": {
    "width": 576,
    "height": 512,
    "path": "M368 400c0 8.8 7.2 16 16 16l176 0c8.8 0 16-7.2 16-16l0-176c0-8.8-7.2-16-16-16s-16 7.2-16 16l0 137.4L331.3 148.7c-6.2-6.2-16.4-6.2-22.6 0L192 265.4 27.3 100.7c-6.2-6.2-16.4-6.2-22.6 0s-6.2 16.4 0 22.6l176 176c6.2 6.2 16.4 6.2 22.6 0L320 182.6 521.4 384 384 384c-8.8 0-16 7.2-16 16z",
  ...
  "faBurgerLight": {
    ...
    "url": "/ui-icons/light/burger.svg"
  },
  "faBuildingLight": {
    "width": 384,
    "height": 512,
    "path": "M64 32C46.3 32 32 46.3 32 64l0 384c0 17.7 14.3 32 32 32l64 0 0-64c0-35.3 28.7-64 64-64s64 28.7 64 64l0 64 64 0c17.7 0 32-14.3 32-32l0-384c0-17.7-14.3-32-32-32L64 32zM224 416c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 64 64 0 0-64zm-96 96l-64 0c-35.3 0-64-28.7-64-64L0 64C0 28.7 28.7 0 64 0L320 0c35.3 0 64 28.7 64 64l0 384c0 35.3-28.7 64-64 64l-64 0-32 0-64 0-32 0zM64 120c0-13.3 10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 48c0 13.3-10.7 24-24 24l-48 0c-13.3 0-24-10.7-24-24l0-48zm32 8l0 32 32 0 0-32-32 0zM248 96l48 0c13.3 0 24 10.7 24 24l0 48c0 13.3-10.7 24-24 24l-48 0c-13.3 0-24-10.7-24-24l0-48c0-13.3 10.7-24 24-24zm8 64l32 0 0-32-32 0 0 32zM64 248c0-13.3 10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 48c0 13.3-10.7 24-24 24l-48 0c-13.3 0-24-10.7-24-24l0-48zm32 8l0 32 32 0 0-32-32 0zm152-32l48 0c13.3 0 24 10.7 24 24l0 48c0 13.3-10.7 24-24 24l-48 0c-13.3 0-24-10.7-24-24l0-48c0-13.3 10.7-24 24-24zm8 64l32 0 0-32-32 0 0 32z",
  ...
  "faArrowTrendUpLight": {
    "width": 576,
    "height": 512,
    "path": "M368 112c0-8.8 7.2-16 16-16l176 0c8.8 0 16 7.2 16 16l0 176c0 8.8-7.2 16-16 16s-16-7.2-16-16l0-137.4L331.3 363.3c-6.2 6.2-16.4 6.2-22.6 0L192 246.6 27.3 411.3c-6.2 6.2-16.4 6.2-22.6 0s-6.2-16.4 0-22.6l176-176c6.2-6.2 16.4-6.2 22.6 0L320 329.4 521.4 128 384 128c-8.8 0-16-7.2-16-16z",
