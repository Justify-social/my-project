        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma_1.prisma.campaignWizard.findMany({
                ...
                case 2:
                    ...
                    transformedCampaigns = campaignsFromDb.map(function (campaign) {
                        ...
                        var frontendReady = enum_transformers_1.EnumTransformers.transformObjectFromBackend(campaign);
                        ...
                        return {
                            ...
                            currency: ((_a = frontendReady.budget) === null || _a === void 0 ? void 0 : _a.currency) || null,
                            totalBudget: ((_b = frontendReady.budget) === null || _b === void 0 ? void 0 : _b.total) || null,
                            socialMediaBudget: ((_c = frontendReady.budget) === null || _c === void 0 ? void 0 : _c.socialMedia) || null,
                    ...
                    // ------------------------
                    console.log("Indexing ".concat(transformedCampaigns.length, " transformed campaigns in Algolia..."));
