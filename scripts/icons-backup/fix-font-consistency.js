 ...
 * 
 * This script analyzes and fixes font-awesome usage throughout the codebase.
 * It ensures consistent use of our icon system and fixes problematic patterns.
 * 
 * Usage:
 *   node scripts/icon-management/fix-font-consistency.js                # Fix all font issues
 *   node scripts/icon-management/fix-font-consistency.js --dry-run      # Check without making changes
 *   node scripts/icon-management/fix-font-consistency.js --path=src/app/campaigns  # Target specific directory
 *   node scripts/icon-management/fix-font-consistency.js --file=src/app/campaigns/wizard/step-1/Step1Content.tsx # Target specific file
 *   node scripts/icon-management/fix-font-consistency.js --stats        # Show statistics only
 *   node scripts/icon-management/fix-font-consistency.js --css          # Include CSS/SCSS files
 *   node scripts/icon-management/fix-font-consistency.js --undo         # Revert previous changes
 *   node scripts/icon-management/fix-font-consistency.js --advanced     # Use advanced heuristics
 *   node scripts/icon-management/fix-font-consistency.js --config=path/to/config.json # Use custom configuration
 *   node scripts/icon-management/fix-font-consistency.js --optimize     # Apply optimizations and deduplicate
 *   node scripts/icon-management/fix-font-consistency.js --validate     # Run validation tests after changes
 * 
...
import cssfontparser from 'css-font-parser';
...
Features: ${features || 'Standard'}
  ...
  if (isDryRun) {
    ...
    if (stats.filesModified > 0) {
      ...
      logInfo('To revert changes, run: node scripts/icon-management/fix-font-consistency.js --undo');
    }
  }
}
 ...
 * {
 *   "scripts": {
 *     "fix:fonts": "node scripts/icon-management/fix-font-consistency.js",
 *     "fix:fonts:dry": "node scripts/icon-management/fix-font-consistency.js --dry-run",
 *     "fix:fonts:css": "node scripts/icon-management/fix-font-consistency.js --css",
 *     "fix:fonts:advanced": "node scripts/icon-management/fix-font-consistency.js --advanced --optimize"
 *   }
 * }
 *
