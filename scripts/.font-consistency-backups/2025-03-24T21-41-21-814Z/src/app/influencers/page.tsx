...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-50">
      ...
      {/* Welcome Message */}
      <p className="text-lg text-[#666666] text-center mb-8">
      ...
      <div className="flex flex-col items-center space-y-4">
        <button
          onClick={startTour}
          className="w-[200px] h-[50px] rounded-[6px] text-[18px] bg-blue-500 text-white py-3 hover:bg-blue-600 transition-colors duration-150"
        ...
        <button
          onClick={handleSkip}
          className="w-[200px] h-[50px] rounded-[6px] text-[18px] bg-gray-500 text-white py-3 hover:bg-gray-600 transition-colors duration-150"
      ...
      {isTourActive && (
        ...
        >
          <div className="bg-white rounded p-6 w-[400px]">
            ...
            {tourError && (
              <p className="text-red-500 mb-4 text-center">{tourError}</p>
            )}
            <div className="flex justify-between mt-6">
              <button
                onClick={previousStep}
                disabled={tourStepIndex === 0}
                className="bg-blue-500 text-white px-4 py-2 rounded transition-opacity duration-150 disabled:opacity-50"
              ...
              {tourStepIndex < tourSteps.length - 1 ? (
                <button
                  onClick={nextStep}
                  className="bg-blue-500 text-white px-4 py-2 rounded transition-colors duration-150 hover:bg-blue-600"
        ...
        >
          <div className="bg-white rounded p-6 w-[400px]">
            ...
            <div className="flex justify-end space-x-4">
              <button
                onClick={cancelSkip}
                className="bg-gray-500 text-white px-4 py-2 rounded transition-colors duration-150 hover:bg-gray-600"
