 ...
 * 
 * Usage:
 *   node scripts/icon-management/check-icon-formatting.js
 *   node scripts/icon-management/check-icon-formatting.js --fix  # Auto-fix issues
 */
...
if (issuesFound > 0 && !shouldFix) {
  ...
  console.log(`  ${colors.gray}node scripts/icon-management/check-icon-formatting.js --fix${colors.reset}`);
}
...
console.log(`     ${colors.cyan}"check-icons": "node scripts/icon-management/check-icon-formatting.js",${colors.reset}`);
console.log(`     ${colors.cyan}"fix-icons": "node scripts/icon-management/check-icon-formatting.js --fix"${colors.reset}`);
